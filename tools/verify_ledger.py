...
def symbol_variants(name: str) -> set[str]:
    ...
    for release_name, current_name in (
        ...
        if name == release_name:
            ...
            values.add(release_name)
    # MSVC member access decorations are A=private, I=protected, and
    # Q=public.  The port intentionally exposes some release-protected
    # helpers publicly; access control is outside the V2 ABI contract.
    ...
    for release_name, current_name in (
        ...
        ("?bdStrlen@@YAIQBD@Z", "?bdStrlen@@YAIPBD@Z"),
        ("?bdStrlcpy@@YAIQADQBDI@Z", "?bdStrlcpy@@YAIPADPBDI@Z"),
        ("?writeDataType@bdBitBuffer@@IAEXW4bdBitBufferDataType@@@Z",
         "?writeDataType@bdBitBuffer@@QAEXW4bdBitBufferDataType@1@@Z"),
        ("?bdStrcmp@@YAHQBD0@Z", "?bdStrcmp@@YAHPBD0@Z"),
        ("?getEmptyStringData@@YAPAVbdStringData@@XZ",
         "?getEmptyStringData@@YAPAUbdStringData@@XZ"),
        ("??8bdString@@QBE_NQBD@Z", "??8bdString@@QBE_NPBD@Z"),
        ("??9bdString@@QBE_NQBD@Z", "??9bdString@@QBE_NPBD@Z"),
        ("?getStringData@bdString@@IBEPAVbdStringData@@XZ",
         "?getStringData@bdString@@QBEPAUbdStringData@@XZ"),
        ("?addReference@bdString@@IBEXPAVbdStringData@@@Z",
         "?addReference@bdString@@QAEPAUbdStringData@@PAU2@@Z"),
        ("?enoughCapacity@bdString@@IBE_NI@Z",
         "?enoughCapacity@bdString@@QBE_NI@Z"),
        ("?allocateBuffer@bdString@@IAEXI@Z",
         "?allocateBuffer@bdString@@QAEPADI@Z"),
        ("?freeBuffer@bdString@@IBEXPAVbdStringData@@@Z",
         "?freeBuffer@bdString@@QAEXPAUbdStringData@@@Z"),
        ("?findFirst@bdString@@QBE_NDAAI@Z",
         "?findFirst@bdString@@QBE_NDPAI@Z"),
        ("?removeReference@bdString@@IBEXPAVbdStringData@@@Z",
         "?removeReference@bdString@@QAEXPAUbdStringData@@@Z"),
        ("??4bdString@@QAEAAV0@QBD@Z",
         "??4bdString@@QAEAAV0@PBD@Z"),
        ("??HbdString@@QBE?AV0@QBD@Z",
         "??HbdString@@QBE?AV0@PBD@Z"),
        ("??YbdString@@QAEAAV0@QBD@Z",
         "??YbdString@@QAEAAV0@PBD@Z"),
        ("?getLength@bdString@@QBEIXZ", "?getLength@bdString@@QBEIXZ"),
    ):
        if name == release_name:
            values.add(current_name)
        elif name == current_name:
