...
class cdWorldBlendPointLitShader;
...
private:
    ...
    friend class cdWorldBlendPointLitShader;
    ...
    friend class cdRiverShader;
    friend void InitCDRiverShader();
    friend class cdGlassShader;
    friend void InitCDGlassShader();
    friend class cdSimpleInstanceShader;
    friend void InitCDSimpleInstanceShader();
    friend class cdGlowShader;
    friend void InitCDGlowShader();
    friend class cdSkyShader;
    friend void InitCDSkyShader();
};
