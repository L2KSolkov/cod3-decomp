...
// ea: 0x00868700
void nalAnimCache::Release()
{
    while (MRUObject != nullptr)
    {
        nalAnimCache::nalObject* object = MRUObject;
...
public:
    ...
    void PostPhysicsUpdate(float deltaT);  // 0x53BFD0
    int Press(int buttonIndex);            // 0x53C080
    int Release(int buttonIndex);          // 0x53C0A0
...
struct nalComponentEntropyFloat1Data : nalComponentData {
    struct SkeletonComponentData {
        float Quantization;
    };
    struct AnimData {
...
class nalComponentEntropyFloat1
    : public nalComponent<nalComponentFloat1Base,
...
struct nalComponentPacked8Float1Data : nalComponentData {
    struct SkeletonComponentData {
        float Bias;
        float Scale;
    };
};
class nalComponentPacked8Float1
    : public nalComponent<nalComponentFloat1Base,
...
struct nalComponentPacked8EntropyFloat3Data : nalComponentData {
    struct SkeletonComponentData {
        float Quantization;
        float Bias;
        float Scale;
    ...
    struct StateType {
        nalEntropyDecoder::nalPackedFloatDecoder<signed char> Decoder[3];
    };
    struct CacheType {
        char x;
        char y;
...
class nalComponentPacked8EntropyFloat3
    : public nalComponent<nalComponentFloat3Base,
...
struct nalComponentPacked8EntropyFloat4Data : nalComponentData {
    struct SkeletonComponentData {
        float Quantization;
        float Bias;
        float Scale;
    ...
    struct StateType {
        nalEntropyDecoder::nalPackedFloatDecoder<signed char> Decoder[4];
    };
    struct CacheType {
        char x;
        char y;
...
class nalComponentPacked8EntropyFloat4
    : public nalComponent<nalComponentFloat4Base,
...
public:
    ...
    static void ComponentConvert(
        math::Vector4* dstPtr,
        const nalComponentPacked8EntropyFloat4Data::CacheType* srcPtr,
        nalComponentData::SkeletonData* skeletonData,
        nalComponentPacked8EntropyFloat4Data::AnimData* animData,
        nalComponentPacked8EntropyFloat4Data::SkeletonComponentData*
            skeletonComponentData,
...
struct nalComponentPacked16EntropyFloat4Data : nalComponentData {
    struct SkeletonComponentData {
        float Quantization;
        float Bias;
        float Scale;
    ...
    struct StateType {
        nalEntropyDecoder::nalPackedFloatDecoder<short> Decoder[4];
    };
    struct CacheType {
        short x;
        short y;
...
class nalComponentPacked16EntropyFloat4
    : public nalComponent<nalComponentFloat4Base,
...
public:
    ...
    static void ComponentConvert(
        math::Vector4* dstPtr,
        const nalComponentPacked16EntropyFloat4Data::CacheType* srcPtr,
        nalComponentData::SkeletonData* skeletonData,
        nalComponentPacked16EntropyFloat4Data::AnimData* animData,
        nalComponentPacked16EntropyFloat4Data::SkeletonComponentData*
            skeletonComponentData,
...
void nalComponent<nalComponentFloat1Base,
                  nalComponentPacked8Float1Data,
                  nalComponentPacked8Float1>::VirtualAdvanceSkeletonComponentData(
    const void*& skeletonComponentData) const
{
    skeletonComponentData = (const char*)skeletonComponentData + 8;
}

template <>
void nalComponent<nalComponentFloat1Base,
                  nalComponentPacked8Float1Data,
                  nalComponentPacked8Float1>::VirtualAlignAnimData(
    const void*& animData) const
{
    (void)animData;
}
...
void nalComponent<nalComponentFloat1Base,
                  nalComponentPacked8Float1Data,
                  nalComponentPacked8Float1>::VirtualAlignAnimComponentData(
    const void*& animComponentData) const
{
    (void)animComponentData;
}
...
void nalComponent<nalComponentFloat1Base,
                  nalComponentPacked8Float1Data,
                  nalComponentPacked8Float1>::VirtualAdvanceAnimComponentData(
    const void*& animComponentData) const
{
    (void)animComponentData;
}
...
void nalComponentPacked16EntropyFloat3::ComponentSetupPartialDecode(
    nalComponentPacked16EntropyFloat3Data::StateType* statePtr,
    const unsigned char** srcPtr)
{
    const unsigned char* cursor = *srcPtr;
...
void nalComponent<nalComponentFloat3Base,
                  nalComponentPacked16EntropyFloat3Data,
                  nalComponentPacked16EntropyFloat3>::SetupPartialDecode(
    nalComponentEnum& componentEnum, void*& state,
    const void*& src, int quantity) const
{
    (void)quantity;
    ...
    *skeletonData = (const void*)(((uintptr_t)*skeletonData + 3u)
    ...
    for (int i = 0; i < componentInfo->Count; ++i)
    {
        ...
        if (nalComponentTrackPresent(&componentEnum, track))
        {
            nalComponentPacked16EntropyFloat3::ComponentSetupPartialDecode(
                (nalComponentPacked16EntropyFloat3Data::StateType*)state,
                (const unsigned char**)&src);
            state = (char*)state + sizeof(nalComponentPacked16EntropyFloat3Data::StateType);
        }
        *skeletonData = (const char*)*skeletonData
...
void nalComponent<nalComponentFloat3Base,
                  nalComponentFloat3Data,
                  nalComponentFloat3>::SetupPartialDecode(
    nalComponentEnum& componentEnum, void*& state,
    const void*& src, int quantity) const
{
    state = (void*)(((uintptr_t)state + 3u) & ~uintptr_t(3u));
...
void nalComponent<nalComponentFloat3Base,
                  nalComponentFloat3Data,
                  nalComponentFloat3>::PartialDecode(
...
void nalComponent<nalComponentFloat3Base,
                  nalComponentFloat3Data,
                  nalComponentFloat3>::GetTrajectory(
...
void nalComponent<nalComponentFloat3Base,
                  nalComponentFloat3Data,
                  nalComponentFloat3>::ReleaseCache(
...
void nalComponent<nalComponentFloat4Base,
                  nalComponentEntropyFloat4Data,
                  nalComponentEntropyFloat4>::Skip(
    nalComponentEnum& componentEnum, void*& dst, const void*& src,
    int quantity) const
{
    const void** customAnimData = componentEnum.CustomAnimData;
    ...
    *customSkeletonData = (const void*)(((uintptr_t)*customSkeletonData + 3u)
    ...
    for (int i = 0; i < componentInfo->Count; ++i)
    {
        ...
        if (nalComponentTrackPresent(&componentEnum, track))
        {
            nalComponentEntropyFloat4::ComponentSkip(
                (const unsigned char**)&src, quantity,
                (nalComponentData::SkeletonData*)skeletonData,
                (nalComponentEntropyFloat4Data::AnimData*)alignedAnimData,
                (nalComponentEntropyFloat4Data::SkeletonComponentData*)
...
// ea: 0x0085C3A0
void nalComponentEntropyFloat4::ComponentSkip(
    const unsigned char** srcPtr, int quantity,
    nalComponentData::SkeletonData* skeletonData,
    nalComponentEntropyFloat4Data::AnimData* animData,
    nalComponentEntropyFloat4Data::SkeletonComponentData*
...
void nalComponent<nalComponentFloat4Base,
                  nalComponentEntropyFloat4Data,
                  nalComponentEntropyFloat4>::Convert(
    nalComponentEnum& componentEnum, void* dst, const void*& src,
    const void* def, const int* offsetTable) const
{
    const void** customAnimData = componentEnum.CustomAnimData;
...
void nalComponent<nalComponentFloat4Base,
                  nalComponentEntropyFloat4Data,
                  nalComponentEntropyFloat4>::GetTrajectory(
    nalComponentEnum& componentEnum, void* dst, bool trajabs,
    const int* offsetTable) const
{
    (void)dst;
    ...
    const void** customAnimData = componentEnum.CustomAnimData;
    const void** customSkeletonData = componentEnum.CustomSkeletonData;
    *customAnimData = (const char*)(((uintptr_t)*customAnimData + 3u)
                                    & ~uintptr_t(3u)) + 4;
    *customSkeletonData = (const void*)(((uintptr_t)*customSkeletonData + 3u)
                                        & ~uintptr_t(3u));
    const nalGeneric::nalComponentInfo* componentInfo =
...
void nalComponent<nalComponentFloat4Base,
                  nalComponentEntropyFloat4Data,
                  nalComponentEntropyFloat4>::Construct(
    const nalGeneric::nalComponentInfo* componentInfo,
    void*& ptr) const
{
    ptr = (void*)(((uintptr_t)ptr + 15u) & ~uintptr_t(15u));
...
void nalComponent<nalComponentFloat4Base,
                  nalComponentEntropyFloat4Data,
                  nalComponentEntropyFloat4>::Delete(
    const nalGeneric::nalComponentInfo* componentInfo,
    void*& ptr) const
{
    ptr = (void*)(((uintptr_t)ptr + 15u) & ~uintptr_t(15u));
...
// ea: 0x0085C780
template <>
void FastCopy<nalComponentEntropyFloat4, math::Vector4>(
    const nalGeneric::nalComponentInfo* componentInfo,
    void*& dstPtr, const void*& srcPtr)
{
    dstPtr = (void*)(((uintptr_t)dstPtr + 15u) & ~uintptr_t(15u));
...
void nalComponent<nalComponentFloat4Base,
                  nalComponentEntropyFloat4Data,
                  nalComponentEntropyFloat4>::Copy(
    const nalGeneric::nalComponentInfo* componentInfo,
    void*& dstPtr, const void*& srcPtr) const
{
    FastCopy<nalComponentEntropyFloat4, math::Vector4>(
        componentInfo, dstPtr, srcPtr);
}
...
void nalComponent<nalComponentFloat4Base,
                  nalComponentEntropyFloat4Data,
                  nalComponentEntropyFloat4>::ReleaseCache(
    nalComponentEnum& componentEnum, void*& ptr) const
{
    ptr = (void*)(((uintptr_t)ptr + 15u) & ~uintptr_t(15u));
    const nalGeneric::nalComponentInfo* componentInfo =
...
void nalComponent<nalComponentFloat4Base,
                  nalComponentPacked8EntropyFloat4Data,
                  nalComponentPacked8EntropyFloat4>::VirtualAdvanceSkeletonComponentData(
    const void*& skeletonComponentData) const
{
...
void nalComponent<nalComponentFloat4Base,
                  nalComponentPacked8EntropyFloat4Data,
                  nalComponentPacked8EntropyFloat4>::VirtualAdvanceAnimData(
    const void*& animData) const
{
    animData = (const char*)animData + 4;
}
...
void nalComponent<nalComponentFloat4Base,
                  nalComponentPacked8EntropyFloat4Data,
                  nalComponentPacked8EntropyFloat4>::VirtualAlignSkeletonData(
    const void*& skeletonData) const
{
    (void)skeletonData;
}
...
void nalComponent<nalComponentFloat4Base,
                  nalComponentPacked8EntropyFloat4Data,
                  nalComponentPacked8EntropyFloat4>::VirtualAdvanceSkeletonData(
    const void*& skeletonData) const
{
    (void)skeletonData;
}
...
void nalComponent<nalComponentFloat4Base,
                  nalComponentPacked8EntropyFloat4Data,
                  nalComponentPacked8EntropyFloat4>::VirtualAlignSkeletonComponentData(
    const void*& skeletonComponentData) const
{
    skeletonComponentData = (const void*)(((uintptr_t)skeletonComponentData + 3u)
                                           & ~uintptr_t(3u));
...
void nalComponent<nalComponentFloat4Base,
                  nalComponentPacked8EntropyFloat4Data,
                  nalComponentPacked8EntropyFloat4>::VirtualAlignAnimData(
    const void*& animData) const
{
    animData = (const void*)(((uintptr_t)animData + 3u)
                             & ~uintptr_t(3u));
...
void nalComponent<nalComponentFloat4Base,
                  nalComponentPacked8EntropyFloat4Data,
                  nalComponentPacked8EntropyFloat4>::VirtualAlignAnimComponentData(
    const void*& animComponentData) const
{
    (void)animComponentData;
}
...
void nalComponent<nalComponentFloat4Base,
                  nalComponentPacked8EntropyFloat4Data,
                  nalComponentPacked8EntropyFloat4>::VirtualAdvanceAnimComponentData(
    const void*& animComponentData) const
{
    (void)animComponentData;
}
...
void nalComponent<nalComponentFloat4Base,
                  nalComponentPacked8EntropyFloat4Data,
                  nalComponentPacked8EntropyFloat4>::Process(
    const nalGeneric::nalComponentInfo* componentInfo,
    void*& pose, void*& extra) const
{
    (void)extra;
...
// ea: 0x0085D630
void nalComponentPacked8EntropyFloat4::ComponentConvert(
    math::Vector4* dstPtr,
    const nalComponentPacked8EntropyFloat4Data::CacheType* srcPtr,
    nalComponentData::SkeletonData* skeletonData,
    nalComponentPacked8EntropyFloat4Data::AnimData* animData,
    ...
    nalComponentData::AnimComponentData* animComponentData)
{
    ...
    (void)animData;
    (void)animComponentData;
    const __m128 packed = _mm_set_ps((float)srcPtr->w, (float)srcPtr->z,
                                     (float)srcPtr->y, (float)srcPtr->x);
    dstPtr->v = _mm_add_ps(
        _mm_mul_ps(packed, _mm_set1_ps(skeletonComponentData->Scale)),
        _mm_set1_ps(skeletonComponentData->Bias));
}
...
void nalComponent<nalComponentFloat4Base,
                  nalComponentPacked8EntropyFloat4Data,
                  nalComponentPacked8EntropyFloat4>::Skip(
    nalComponentEnum& componentEnum, void*& dst, const void*& src,
    int quantity) const
{
    const void** customAnimData = componentEnum.CustomAnimData;
    ...
    *customSkeletonData = (const void*)(((uintptr_t)*customSkeletonData + 3u)
    ...
    for (int i = 0; i < componentInfo->Count; ++i)
    {
        ...
        if (nalComponentTrackPresent(&componentEnum, track))
        {
            nalComponentPacked8EntropyFloat4::ComponentSkip(
                (const unsigned char**)&src, quantity,
                (nalComponentData::SkeletonData*)skeletonData,
                (nalComponentPacked8EntropyFloat4Data::AnimData*)animData,
                (nalComponentPacked8EntropyFloat4Data::SkeletonComponentData*)
...
void nalComponent<nalComponentFloat4Base,
                  nalComponentPacked8EntropyFloat4Data,
                  nalComponentPacked8EntropyFloat4>::Convert(
    nalComponentEnum& componentEnum, void* dst, const void*& src,
    const void* def, const int* offsetTable) const
{
    const void** customAnimData = componentEnum.CustomAnimData;
    ...
    *customSkeletonData = (const void*)(((uintptr_t)*customSkeletonData + 3u)
    ...
    for (int i = 0; i < componentInfo->Count; ++i)
    {
        ...
        {
            nalComponentPacked8EntropyFloat4::ComponentConvert(
                (math::Vector4*)(out + offset),
                (const nalComponentPacked8EntropyFloat4Data::CacheType*)src,
                (nalComponentData::SkeletonData*)skeletonData,
                (nalComponentPacked8EntropyFloat4Data::AnimData*)animData,
                (nalComponentPacked8EntropyFloat4Data::SkeletonComponentData*)
                    *customSkeletonData,
        ...
        {
            std::memcpy(out + offset, defaults + offset, sizeof(math::Vector4));
        }
        *customSkeletonData =
            (const char*)*customSkeletonData
            + sizeof(nalComponentPacked8EntropyFloat4Data::SkeletonComponentData);
...
void nalComponent<nalComponentFloat4Base,
                  nalComponentPacked8EntropyFloat4Data,
                  nalComponentPacked8EntropyFloat4>::GetTrajectory(
    nalComponentEnum& componentEnum, void* dst, bool trajabs,
    const int* offsetTable) const
{
    (void)dst;
...
void nalComponent<nalComponentFloat4Base,
                  nalComponentPacked8EntropyFloat4Data,
                  nalComponentPacked8EntropyFloat4>::Construct(
    const nalGeneric::nalComponentInfo* componentInfo, void*& ptr) const
{
    ptr = (void*)(((uintptr_t)ptr + 15u) & ~uintptr_t(15u));
    ptr = (char*)ptr + 16 * componentInfo->Count;
...
void nalComponent<nalComponentFloat4Base,
                  nalComponentPacked8EntropyFloat4Data,
                  nalComponentPacked8EntropyFloat4>::Delete(
    const nalGeneric::nalComponentInfo* componentInfo, void*& ptr) const
{
    ptr = (void*)(((uintptr_t)ptr + 15u) & ~uintptr_t(15u));
    for (int i = 0; i < componentInfo->Count; ++i)
...
// ea: 0x0085D940
template <>
void FastCopy<nalComponentPacked8EntropyFloat4, math::Vector4>(
    const nalGeneric::nalComponentInfo* componentInfo,
    void*& dstPtr, const void*& srcPtr)
{
    dstPtr = (void*)(((uintptr_t)dstPtr + 15u) & ~uintptr_t(15u));
...
void nalComponent<nalComponentFloat4Base,
                  nalComponentPacked8EntropyFloat4Data,
                  nalComponentPacked8EntropyFloat4>::Copy(
    const nalGeneric::nalComponentInfo* componentInfo,
    void*& dstPtr, const void*& srcPtr) const
{
    FastCopy<nalComponentPacked8EntropyFloat4, math::Vector4>(
        componentInfo, dstPtr, srcPtr);
}
...
void nalComponent<nalComponentFloat4Base,
                  nalComponentPacked8EntropyFloat4Data,
                  nalComponentPacked8EntropyFloat4>::ReleaseCache(
    nalComponentEnum& componentEnum, void*& ptr) const
{
    const nalGeneric::nalComponentInfo* componentInfo =
        componentEnum.ComponentInfo;
...
void nalComponent<nalComponentFloat4Base,
                  nalComponentPacked16EntropyFloat4Data,
                  nalComponentPacked16EntropyFloat4>::SetupPartialDecode(
    nalComponentEnum& componentEnum, void*& state,
    const void*& src, int quantity) const
{
    const void** customAnimData = componentEnum.CustomAnimData;
    ...
    const auto* animData =
        (const nalComponentPacked16EntropyFloat4Data::AnimData*)
            (((uintptr_t)*customAnimData + 3u) & ~uintptr_t(3u));
    *customAnimData = (const char*)animData
                      + sizeof(nalComponentPacked16EntropyFloat4Data::AnimData);
    *customSkeletonData = (const void*)(((uintptr_t)*customSkeletonData + 3u)
                                        & ~uintptr_t(3u));
    ...
    for (int i = 0; i < componentInfo->Count; ++i)
    {
        ...
        if (nalComponentTrackPresent(&componentEnum, track))
        {
            nalComponentPacked16EntropyFloat4::ComponentSetupPartialDecode(
                ...
                (nalComponentData::AnimComponentData*)*customAnimData);
            state = (char*)state
                    + sizeof(nalComponentPacked16EntropyFloat4Data::StateType);
        }
        *customSkeletonData =
            (const char*)*customSkeletonData
            + sizeof(nalComponentPacked16EntropyFloat4Data::SkeletonComponentData);
    }
}

// ea: 0x0085DC30
void nalComponentPacked16EntropyFloat4::ComponentSetupPartialDecode(
    nalComponentPacked16EntropyFloat4Data::StateType* statePtr,
    const unsigned char** srcPtr, int quantity,
    nalComponentData::SkeletonData* skeletonData,
    nalComponentPacked16EntropyFloat4Data::AnimData* animData,
    ...
    nalComponentData::AnimComponentData* animComponentData)
{
    ...
    const unsigned char channel1Size = *cursor++;
    if (statePtr != (nalComponentPacked16EntropyFloat4Data::StateType*)-16)
    {
        statePtr->Decoder[1].channel.ptr = cursor;
        statePtr->Decoder[1].channel.bitpos = 0;
        statePtr->Decoder[1].channel.decoder = 0xFF;
    ...
    const unsigned char channel2Size = *cursor++;
    if (statePtr != (nalComponentPacked16EntropyFloat4Data::StateType*)-32)
    {
        statePtr->Decoder[2].channel.ptr = cursor;
        statePtr->Decoder[2].channel.bitpos = 0;
        statePtr->Decoder[2].channel.decoder = 0xFF;
    ...
    const unsigned char channel3Size = *cursor++;
    if (statePtr != (nalComponentPacked16EntropyFloat4Data::StateType*)-48)
    {
        statePtr->Decoder[3].channel.ptr = cursor;
        statePtr->Decoder[3].channel.bitpos = 0;
        statePtr->Decoder[3].channel.zeroes = 0;
...
// ea: 0x0085E610
void nalComponentPacked16EntropyFloat4::ComponentSkip(
    const unsigned char** srcPtr, int quantity,
    nalComponentData::SkeletonData* skeletonData,
    nalComponentPacked16EntropyFloat4Data::AnimData* animData,
    nalComponentPacked16EntropyFloat4Data::SkeletonComponentData*
...
// ea: 0x0085E7F0
void nalComponentPacked16EntropyFloat4::ComponentConvert(
    math::Vector4* dstPtr,
    const nalComponentPacked16EntropyFloat4Data::CacheType* srcPtr,
    nalComponentData::SkeletonData* skeletonData,
    nalComponentPacked16EntropyFloat4Data::AnimData* animData,
...
void nalComponent<nalComponentFloat4Base,
                  nalComponentPacked16EntropyFloat4Data,
                  nalComponentPacked16EntropyFloat4>::Skip(
    nalComponentEnum& componentEnum, void*& dst, const void*& src,
    int quantity) const
{
    const void** customAnimData = componentEnum.CustomAnimData;
    ...
    *customSkeletonData = (const void*)(((uintptr_t)*customSkeletonData + 3u)
    ...
    for (int i = 0; i < componentInfo->Count; ++i)
    {
        ...
        if (nalComponentTrackPresent(&componentEnum, track))
        {
            nalComponentPacked16EntropyFloat4::ComponentSkip(
                (const unsigned char**)&src, quantity,
                (nalComponentData::SkeletonData*)skeletonData,
                (nalComponentPacked16EntropyFloat4Data::AnimData*)animData,
                (nalComponentPacked16EntropyFloat4Data::SkeletonComponentData*)
...
void nalComponent<nalComponentFloat4Base,
                  nalComponentPacked16EntropyFloat4Data,
                  nalComponentPacked16EntropyFloat4>::Convert(
    nalComponentEnum& componentEnum, void* dst, const void*& src,
    const void* def, const int* offsetTable) const
{
    const void** customAnimData = componentEnum.CustomAnimData;
    ...
    *customSkeletonData = (const void*)(((uintptr_t)*customSkeletonData + 3u)
    ...
    for (int i = 0; i < componentInfo->Count; ++i)
    {
        ...
        {
            nalComponentPacked16EntropyFloat4::ComponentConvert(
                (math::Vector4*)(out + offset),
                (const nalComponentPacked16EntropyFloat4Data::CacheType*)src,
                (nalComponentData::SkeletonData*)skeletonData,
                (nalComponentPacked16EntropyFloat4Data::AnimData*)animData,
                (nalComponentPacked16EntropyFloat4Data::SkeletonComponentData*)
                    *customSkeletonData,
...
void nalComponent<nalComponentFloat4Base,
                  nalComponentPacked16EntropyFloat4Data,
                  nalComponentPacked16EntropyFloat4>::GetTrajectory(
    nalComponentEnum& componentEnum, void* dst, bool trajabs,
    const int* offsetTable) const
{
    (void)dst;
...
void nalComponent<nalComponentFloat4Base,
                  nalComponentPacked16EntropyFloat4Data,
                  nalComponentPacked16EntropyFloat4>::Construct(
    const nalGeneric::nalComponentInfo* componentInfo, void*& ptr) const
{
    ptr = (void*)(((uintptr_t)ptr + 15u) & ~uintptr_t(15u));
    ptr = (char*)ptr + 16 * componentInfo->Count;
...
void nalComponent<nalComponentFloat4Base,
                  nalComponentPacked16EntropyFloat4Data,
                  nalComponentPacked16EntropyFloat4>::Delete(
    const nalGeneric::nalComponentInfo* componentInfo, void*& ptr) const
{
    ptr = (void*)(((uintptr_t)ptr + 15u) & ~uintptr_t(15u));
    for (int i = 0; i < componentInfo->Count; ++i)
...
// ea: 0x0085EB00
template <>
void FastCopy<nalComponentPacked16EntropyFloat4, math::Vector4>(
    const nalGeneric::nalComponentInfo* componentInfo,
    void*& dstPtr, const void*& srcPtr)
{
    dstPtr = (void*)(((uintptr_t)dstPtr + 15u) & ~uintptr_t(15u));
...
void nalComponent<nalComponentFloat4Base,
                  nalComponentPacked16EntropyFloat4Data,
                  nalComponentPacked16EntropyFloat4>::Copy(
    const nalGeneric::nalComponentInfo* componentInfo,
    void*& dstPtr, const void*& srcPtr) const
{
    FastCopy<nalComponentPacked16EntropyFloat4, math::Vector4>(
        componentInfo, dstPtr, srcPtr);
}
...
void nalComponent<nalComponentFloat4Base,
                  nalComponentPacked16EntropyFloat4Data,
                  nalComponentPacked16EntropyFloat4>::ReleaseCache(
    nalComponentEnum& componentEnum, void*& ptr) const
{
...
void nalComponent<nalComponentQuatBase,
                  ...
                  nalComponentEntropyQuat>::VirtualAdvanceSkeletonComponentData(
    const void*& skeletonComponentData) const
{
    skeletonComponentData = (const char*)skeletonComponentData + 4;
}
...
void nalComponent<nalComponentQuatBase,
                  nalComponentEntropyQuatData,
                  nalComponentEntropyQuat>::VirtualAdvanceAnimData(
    const void*& animData) const
{
    animData = (const char*)animData + 4;
}
...
void nalComponent<nalComponentQuatBase,
                  nalComponentEntropyQuatData,
                  nalComponentEntropyQuat>::VirtualAlignSkeletonData(
    const void*& skeletonData) const
{
    (void)skeletonData;
}
...
void nalComponent<nalComponentQuatBase,
                  nalComponentEntropyQuatData,
                  nalComponentEntropyQuat>::VirtualAdvanceSkeletonData(
    const void*& skeletonData) const
{
    (void)skeletonData;
}
...
void nalComponent<nalComponentQuatBase,
                  nalComponentEntropyQuatData,
                  nalComponentEntropyQuat>::VirtualAlignSkeletonComponentData(
    const void*& skeletonComponentData) const
{
    skeletonComponentData = (const void*)(((uintptr_t)skeletonComponentData + 3u)
                                           & ~uintptr_t(3u));
...
void nalComponent<nalComponentQuatBase,
                  nalComponentEntropyQuatData,
                  nalComponentEntropyQuat>::VirtualAlignAnimData(
    const void*& animData) const
{
    animData = (const void*)(((uintptr_t)animData + 3u)
                             & ~uintptr_t(3u));
...
void nalComponent<nalComponentQuatBase,
                  nalComponentEntropyQuatData,
                  nalComponentEntropyQuat>::VirtualAlignAnimComponentData(
    const void*& animComponentData) const
{
    (void)animComponentData;
}
...
void nalComponent<nalComponentQuatBase,
                  nalComponentEntropyQuatData,
                  nalComponentEntropyQuat>::VirtualAdvanceAnimComponentData(
    const void*& animComponentData) const
{
    (void)animComponentData;
}
...
void nalComponent<nalComponentQuatBase,
                  nalComponentEntropyQuatData,
                  nalComponentEntropyQuat>::Process(
    const nalGeneric::nalComponentInfo* componentInfo,
    void*& pose, void*& extra) const
{
    (void)extra;
...
void nalComponent<nalComponentQuatBase,
                  nalComponentEntropyQuatData,
                  nalComponentEntropyQuat>::Construct(
    const nalGeneric::nalComponentInfo* componentInfo, void*& ptr) const
{
    ptr = (void*)(((uintptr_t)ptr + 15u) & ~uintptr_t(15u));
    ptr = (char*)ptr + 16 * componentInfo->Count;
...
void nalComponent<nalComponentQuatBase,
                  nalComponentEntropyQuatData,
                  nalComponentEntropyQuat>::Delete(
    const nalGeneric::nalComponentInfo* componentInfo, void*& ptr) const
{
    ptr = (void*)(((uintptr_t)ptr + 15u) & ~uintptr_t(15u));
    for (int i = 0; i < componentInfo->Count; ++i)
...
// ea: 0x00860570
template <>
void FastCopy<nalComponentEntropyQuat, math::Quaternion>(
    const nalGeneric::nalComponentInfo* componentInfo,
    void*& dstPtr, const void*& srcPtr)
{
    dstPtr = (void*)(((uintptr_t)dstPtr + 15u) & ~uintptr_t(15u));
...
void nalComponent<nalComponentQuatBase,
                  nalComponentEntropyQuatData,
                  nalComponentEntropyQuat>::Copy(
    const nalGeneric::nalComponentInfo* componentInfo,
    void*& dstPtr, const void*& srcPtr) const
{
    FastCopy<nalComponentEntropyQuat, math::Quaternion>(
        componentInfo, dstPtr, srcPtr);
}
...
void nalComponent<nalComponentQuatBase,
                  nalComponentEntropyQuatData,
                  nalComponentEntropyQuat>::ReleaseCache(
    nalComponentEnum& componentEnum, void*& ptr) const
{
    ptr = (void*)(((uintptr_t)ptr + 15u) & ~uintptr_t(15u));
    const nalGeneric::nalComponentInfo* componentInfo =
...
void nalComponent<nalComponentQuatBase,
                  ...
                  nalComponentPacked16EntropyQuat>::VirtualAdvanceSkeletonComponentData(
    const void*& skeletonComponentData) const
{
    skeletonComponentData = (const char*)skeletonComponentData + 4;
}
...
void nalComponent<nalComponentQuatBase,
                  nalComponentPacked16EntropyQuatData,
                  nalComponentPacked16EntropyQuat>::VirtualAdvanceAnimData(
    const void*& animData) const
{
    animData = (const char*)animData + 4;
}
...
void nalComponent<nalComponentQuatBase,
                  nalComponentPacked16EntropyQuatData,
                  nalComponentPacked16EntropyQuat>::VirtualAlignSkeletonData(
    const void*& skeletonData) const
{
    (void)skeletonData;
}
...
void nalComponent<nalComponentQuatBase,
                  nalComponentPacked16EntropyQuatData,
                  nalComponentPacked16EntropyQuat>::VirtualAdvanceSkeletonData(
    const void*& skeletonData) const
{
    (void)skeletonData;
}
...
void nalComponent<nalComponentQuatBase,
                  nalComponentPacked16EntropyQuatData,
                  nalComponentPacked16EntropyQuat>::VirtualAlignSkeletonComponentData(
    const void*& skeletonComponentData) const
{
    skeletonComponentData = (const void*)(((uintptr_t)skeletonComponentData + 3u)
                                           & ~uintptr_t(3u));
...
void nalComponent<nalComponentQuatBase,
                  nalComponentPacked16EntropyQuatData,
                  nalComponentPacked16EntropyQuat>::VirtualAlignAnimData(
    const void*& animData) const
{
    animData = (const void*)(((uintptr_t)animData + 3u)
                             & ~uintptr_t(3u));
...
void nalComponent<nalComponentQuatBase,
                  nalComponentPacked16EntropyQuatData,
                  nalComponentPacked16EntropyQuat>::VirtualAlignAnimComponentData(
    const void*& animComponentData) const
{
    (void)animComponentData;
}
...
void nalComponent<nalComponentQuatBase,
                  nalComponentPacked16EntropyQuatData,
                  nalComponentPacked16EntropyQuat>::VirtualAdvanceAnimComponentData(
    const void*& animComponentData) const
{
    (void)animComponentData;
}
...
void nalComponent<nalComponentQuatBase,
                  nalComponentPacked16EntropyQuatData,
                  nalComponentPacked16EntropyQuat>::Process(
    const nalGeneric::nalComponentInfo* componentInfo,
    void*& pose, void*& extra) const
{
    (void)extra;
...
void nalComponent<nalComponentPOBase,
                  ...
                  nalComponentEntropyPO>::VirtualAdvanceSkeletonComponentData(
    const void*& skeletonComponentData) const
{
    skeletonComponentData = (const char*)skeletonComponentData + 8;
}
...
void nalComponent<nalComponentPOBase,
                  nalComponentEntropyPOData,
                  nalComponentEntropyPO>::VirtualAdvanceAnimData(
    const void*& animData) const
{
    animData = (const char*)animData + 4;
}
...
void nalComponent<nalComponentPOBase,
                  nalComponentEntropyPOData,
                  nalComponentEntropyPO>::VirtualAlignSkeletonData(
    const void*& skeletonData) const
{
    (void)skeletonData;
}
...
void nalComponent<nalComponentPOBase,
                  nalComponentEntropyPOData,
                  nalComponentEntropyPO>::VirtualAdvanceSkeletonData(
    const void*& skeletonData) const
{
    (void)skeletonData;
}
...
void nalComponent<nalComponentPOBase,
                  nalComponentEntropyPOData,
                  nalComponentEntropyPO>::VirtualAlignSkeletonComponentData(
    const void*& skeletonComponentData) const
{
    skeletonComponentData = (const void*)(((uintptr_t)skeletonComponentData + 3u)
                                           & ~uintptr_t(3u));
...
void nalComponent<nalComponentPOBase,
                  nalComponentEntropyPOData,
                  nalComponentEntropyPO>::VirtualAlignAnimData(
    const void*& animData) const
{
    animData = (const void*)(((uintptr_t)animData + 3u)
                             & ~uintptr_t(3u));
...
void nalComponent<nalComponentPOBase,
                  nalComponentEntropyPOData,
                  nalComponentEntropyPO>::VirtualAlignAnimComponentData(
    const void*& animComponentData) const
{
    (void)animComponentData;
}
...
void nalComponent<nalComponentPOBase,
                  nalComponentEntropyPOData,
                  nalComponentEntropyPO>::VirtualAdvanceAnimComponentData(
    const void*& animComponentData) const
{
    (void)animComponentData;
}
    ...
    const void* def, const int* offsetTable) const
{
    ...
    for (int i = 0; i < componentInfo->Count; ++i)
    {
        ...
        {
            std::memcpy(target, defaults + offset, 32);
        }
    }
}
    ...
    const void* def, const int* offsetTable) const
{
    ...
    const void** customAnimData = componentEnum.CustomAnimData;
    const void** customSkeletonData = componentEnum.CustomSkeletonData;
    void* current = (void*)(((uintptr_t)src + 15u) & ~uintptr_t(15u));
    src = current;
    const nalGeneric::nalComponentInfo* componentInfo =
        componentEnum.ComponentInfo;
    ...
    for (int i = 0; i < componentInfo->Count; ++i)
    {
        const int offset = offsetTable[i + componentInfo->StartIndex];
        std::memcpy((char*)dst + offset, current, 32);
...
void nalComponent<nalComponentPOBase,
                  nalComponentEntropyPOData,
                  nalComponentEntropyPO>::GetTrajectory(
    nalComponentEnum& componentEnum, void* dst, bool trajabs,
    const int* offsetTable) const
{
    (void)dst;
    ...
    const void** customSkeletonData = componentEnum.CustomSkeletonData;
    *componentEnum.CustomAnimData =
        (const void*)(((uintptr_t)*componentEnum.CustomAnimData + 3u)
                      & ~uintptr_t(3u));
    *componentEnum.CustomAnimData =
        (const char*)*componentEnum.CustomAnimData + 4;
    *customSkeletonData =
        (const void*)(((uintptr_t)*customSkeletonData + 3u)
                      & ~uintptr_t(3u));
    const nalGeneric::nalComponentInfo* componentInfo =
...
void nalComponent<nalComponentPOBase,
                  nalComponentEntropyPOData,
                  nalComponentEntropyPO>::Construct(
    const nalGeneric::nalComponentInfo* componentInfo, void*& ptr) const
{
    ptr = (void*)(((uintptr_t)ptr + 15u) & ~uintptr_t(15u));
    ptr = (char*)ptr + 32 * componentInfo->Count;
...
// ea: 0x00862900
template <>
void FastCopy<nalComponentEntropyPO, nalPositionOrientation>(
    const nalGeneric::nalComponentInfo* componentInfo,
    void*& dstPtr, const void*& srcPtr)
{
    dstPtr = (void*)(((uintptr_t)dstPtr + 15u) & ~uintptr_t(15u));
...
void nalComponent<nalComponentPOBase,
                  nalComponentEntropyPOData,
                  nalComponentEntropyPO>::Copy(
    const nalGeneric::nalComponentInfo* componentInfo,
    void*& dstPtr, const void*& srcPtr) const
{
    FastCopy<nalComponentEntropyPO, nalPositionOrientation>(
        componentInfo, dstPtr, srcPtr);
}
...
void nalComponent<nalComponentPOBase,
                  nalComponentEntropyPOData,
                  nalComponentEntropyPO>::ReleaseCache(
    nalComponentEnum& componentEnum, void*& ptr) const
{
    ptr = (void*)(((uintptr_t)ptr + 15u) & ~uintptr_t(15u));
    const nalGeneric::nalComponentInfo* componentInfo =
...
void nalComponent<nalComponentPOBase,
                  nalComponentEntropyTrajectoryPOData,
                  nalComponentEntropyTrajectoryPO>::VirtualAdvanceSkeletonComponentData(
    const void*& skeletonComponentData) const
{
    skeletonComponentData = (const char*)skeletonComponentData + 8;
}
...
void nalComponent<nalComponentPOBase,
                  nalComponentEntropyTrajectoryPOData,
                  nalComponentEntropyTrajectoryPO>::VirtualAdvanceAnimData(
    const void*& animData) const
{
    animData = (const char*)animData + 4;
}
...
void nalComponent<nalComponentPOBase,
                  nalComponentEntropyTrajectoryPOData,
                  nalComponentEntropyTrajectoryPO>::VirtualAdvanceAnimComponentData(
    const void*& animComponentData) const
{
    animComponentData = (const char*)animComponentData + 32;
}
...
void nalComponent<nalComponentPOBase,
                  nalComponentEntropyTrajectoryPOData,
                  nalComponentEntropyTrajectoryPO>::VirtualAlignSkeletonData(
    const void*& skeletonData) const
{
    (void)skeletonData;
}
...
void nalComponent<nalComponentPOBase,
                  nalComponentEntropyTrajectoryPOData,
                  nalComponentEntropyTrajectoryPO>::VirtualAdvanceSkeletonData(
    const void*& skeletonData) const
{
    (void)skeletonData;
}
...
void nalComponent<nalComponentPOBase,
                  nalComponentEntropyTrajectoryPOData,
                  nalComponentEntropyTrajectoryPO>::VirtualAlignSkeletonComponentData(
    const void*& skeletonComponentData) const
{
    skeletonComponentData = (const void*)(((uintptr_t)skeletonComponentData + 3u)
                                           & ~uintptr_t(3u));
...
void nalComponent<nalComponentPOBase,
                  nalComponentEntropyTrajectoryPOData,
                  nalComponentEntropyTrajectoryPO>::VirtualAlignAnimData(
    const void*& animData) const
{
    animData = (const void*)(((uintptr_t)animData + 3u)
                             & ~uintptr_t(3u));
...
void nalComponent<nalComponentPOBase,
                  nalComponentEntropyTrajectoryPOData,
                  nalComponentEntropyTrajectoryPO>::VirtualAlignAnimComponentData(
    const void*& animComponentData) const
{
    animComponentData = (const void*)(((uintptr_t)animComponentData + 15u)
                                       & ~uintptr_t(15u));
...
void nalComponent<nalComponentPOBase,
                  nalComponentEntropyTrajectoryPOData,
                  nalComponentEntropyTrajectoryPO>::Process(
    const nalGeneric::nalComponentInfo* componentInfo,
    void*& pose, void*& extra) const
{
    (void)extra;
...
void nalComponent<nalComponentFloat3Base,
                  nalComponentEntropyFloat3Data,
                  nalComponentEntropyFloat3>::GetTrajectory(
    nalComponentEnum& componentEnum, void* dst, bool trajabs,
    const int* offsetTable) const
{
    (void)dst;
...
void nalComponent<nalComponentFloat3Base,
                  nalComponentEntropyFloat3Data,
                  nalComponentEntropyFloat3>::Construct(
    const nalGeneric::nalComponentInfo* componentInfo, void*& ptr) const
{
    ptr = (void*)(((uintptr_t)ptr + 15u) & ~uintptr_t(15u));
    ptr = (char*)ptr + 16 * componentInfo->Count;
...
void nalComponent<nalComponentFloat3Base,
                  nalComponentEntropyFloat3Data,
                  nalComponentEntropyFloat3>::Delete(
    const nalGeneric::nalComponentInfo* componentInfo, void*& ptr) const
{
    ptr = (void*)(((uintptr_t)ptr + 15u) & ~uintptr_t(15u));
    for (int i = 0; i < componentInfo->Count; ++i)
...
template <>
void FastCopy<nalComponentEntropyFloat3, math::Dir3>(
    const nalGeneric::nalComponentInfo* componentInfo,
    void*& dstPtr, const void*& srcPtr)
{
    dstPtr = (void*)(((uintptr_t)dstPtr + 15u) & ~uintptr_t(15u));
...
void nalComponent<nalComponentFloat3Base,
                  nalComponentEntropyFloat3Data,
                  nalComponentEntropyFloat3>::Copy(
    const nalGeneric::nalComponentInfo* componentInfo,
    void*& dstPtr, const void*& srcPtr) const
{
    FastCopy<nalComponentEntropyFloat3, math::Dir3>(
        componentInfo, dstPtr, srcPtr);
}
...
void nalComponent<nalComponentFloat3Base,
                  nalComponentEntropyFloat3Data,
                  nalComponentEntropyFloat3>::ReleaseCache(
    nalComponentEnum& componentEnum, void*& ptr) const
{
    ptr = (void*)(((uintptr_t)ptr + 15u) & ~uintptr_t(15u));
    const nalGeneric::nalComponentInfo* componentInfo =
...
void nalComponent<nalComponentFloat3Base,
                  nalComponentPacked8EntropyFloat3Data,
                  nalComponentPacked8EntropyFloat3>::VirtualAdvanceSkeletonComponentData(
    const void*& skeletonComponentData) const
{
    skeletonComponentData = (const char*)skeletonComponentData + 12;
}
...
void nalComponent<nalComponentFloat3Base,
                  nalComponentPacked8EntropyFloat3Data,
                  nalComponentPacked8EntropyFloat3>::VirtualAdvanceAnimData(
    const void*& animData) const
{
    animData = (const char*)animData + 4;
}
...
void nalComponent<nalComponentFloat3Base,
                  nalComponentPacked8EntropyFloat3Data,
                  nalComponentPacked8EntropyFloat3>::VirtualAlignSkeletonData(
    const void*& skeletonData) const
{
    (void)skeletonData;
}
...
void nalComponent<nalComponentFloat3Base,
                  nalComponentPacked8EntropyFloat3Data,
                  nalComponentPacked8EntropyFloat3>::VirtualAdvanceSkeletonData(
    const void*& skeletonData) const
{
    (void)skeletonData;
}
...
void nalComponent<nalComponentFloat3Base,
                  nalComponentPacked8EntropyFloat3Data,
                  nalComponentPacked8EntropyFloat3>::VirtualAlignSkeletonComponentData(
    const void*& skeletonComponentData) const
{
    skeletonComponentData = (const void*)(((uintptr_t)skeletonComponentData + 3u)
                                           & ~uintptr_t(3u));
...
void nalComponent<nalComponentFloat3Base,
                  nalComponentPacked8EntropyFloat3Data,
                  nalComponentPacked8EntropyFloat3>::VirtualAlignAnimData(
    const void*& animData) const
{
    animData = (const void*)(((uintptr_t)animData + 3u)
                             & ~uintptr_t(3u));
...
void nalComponent<nalComponentFloat3Base,
                  nalComponentPacked8EntropyFloat3Data,
                  nalComponentPacked8EntropyFloat3>::VirtualAlignAnimComponentData(
    const void*& animComponentData) const
{
    (void)animComponentData;
}
...
void nalComponent<nalComponentFloat3Base,
                  nalComponentPacked8EntropyFloat3Data,
                  nalComponentPacked8EntropyFloat3>::VirtualAdvanceAnimComponentData(
    const void*& animComponentData) const
{
    (void)animComponentData;
}
...
void nalComponent<nalComponentFloat3Base,
                  nalComponentPacked8EntropyFloat3Data,
                  nalComponentPacked8EntropyFloat3>::Process(
    const nalGeneric::nalComponentInfo* componentInfo,
    void*& pose, void*& extra) const
{
    (void)extra;
...
void nalComponent<nalComponentFloat3Base,
                  nalComponentPacked8EntropyFloat3Data,
                  nalComponentPacked8EntropyFloat3>::Skip(
    nalComponentEnum& componentEnum, void*& dst, const void*& src,
    int quantity) const
{
    (void)quantity;
...
void nalComponent<nalComponentFloat3Base,
                  nalComponentPacked8EntropyFloat3Data,
                  nalComponentPacked8EntropyFloat3>::GetTrajectory(
    nalComponentEnum& componentEnum, void* dst, bool trajabs,
    const int* offsetTable) const
{
    (void)dst;
...
void nalComponent<nalComponentFloat3Base,
                  nalComponentPacked8EntropyFloat3Data,
                  nalComponentPacked8EntropyFloat3>::Construct(
    const nalGeneric::nalComponentInfo* componentInfo, void*& ptr) const
{
    ptr = (void*)(((uintptr_t)ptr + 15u) & ~uintptr_t(15u));
    ptr = (char*)ptr + 16 * componentInfo->Count;
...
void nalComponent<nalComponentFloat3Base,
                  nalComponentPacked8EntropyFloat3Data,
                  nalComponentPacked8EntropyFloat3>::Delete(
    const nalGeneric::nalComponentInfo* componentInfo, void*& ptr) const
{
    ptr = (void*)(((uintptr_t)ptr + 15u) & ~uintptr_t(15u));
    for (int i = 0; i < componentInfo->Count; ++i)
...
template <>
void FastCopy<nalComponentPacked8EntropyFloat3, math::Dir3>(
    const nalGeneric::nalComponentInfo* componentInfo,
    void*& dstPtr, const void*& srcPtr)
{
    dstPtr = (void*)(((uintptr_t)dstPtr + 15u) & ~uintptr_t(15u));
...
void nalComponent<nalComponentFloat3Base,
                  nalComponentPacked8EntropyFloat3Data,
                  nalComponentPacked8EntropyFloat3>::Copy(
    const nalGeneric::nalComponentInfo* componentInfo,
    void*& dstPtr, const void*& srcPtr) const
{
    FastCopy<nalComponentPacked8EntropyFloat3, math::Dir3>(
        componentInfo, dstPtr, srcPtr);
}
...
void nalComponent<nalComponentFloat3Base,
                  nalComponentPacked8EntropyFloat3Data,
                  nalComponentPacked8EntropyFloat3>::ReleaseCache(
    nalComponentEnum& componentEnum, void*& ptr) const
{
    const nalGeneric::nalComponentInfo* componentInfo =
        componentEnum.ComponentInfo;
...
void nalComponent<nalComponentFloat1Base,
                  nalComponentEntropyFloat1Data,
                  nalComponentEntropyFloat1>::Copy(
    const nalGeneric::nalComponentInfo* componentInfo,
    void*& dstPtr, const void*& srcPtr) const
{
    FastCopy<nalComponentEntropyFloat1, float>(
        componentInfo, &dstPtr, &srcPtr);
}
...
{
    *dstPtr = (void*)(((uintptr_t)*dstPtr + 15u) & ~uintptr_t(15u));
    const void* alignedSrc =
        (const void*)(((uintptr_t)*srcPtr + 15u) & ~uintptr_t(15u));
    *srcPtr = alignedSrc;
    const unsigned int size = 16u * componentInfo->Count;
...
void nalComponent<nalComponentFloat3Base,
                  nalComponentFloat3Data,
                  nalComponentFloat3>::Copy(
    const nalGeneric::nalComponentInfo* componentInfo,
    void*& dstPtr, const void*& srcPtr) const
{
    FastCopy<nalComponentFloat3, math::Dir3>(
        componentInfo, &dstPtr, &srcPtr);
}
...
// ?Delete@?$nalComponent@VnalComponentFloat1Base@@VnalComponentEntropyFloat1Data@@VnalComponentEntropyFloat1@@@@UBEXPBUnalComponentInfo@nalGeneric@@AAPAX@Z
// (nal_init.o 0x857540)
template <>
void nalComponent<nalComponentFloat1Base,
                  nalComponentEntropyFloat1Data,
                  nalComponentEntropyFloat1>::Delete(
    const nalGeneric::nalComponentInfo* componentInfo, void*& ptr) const
{
    ptr = (void*)(((uintptr_t)ptr + 3u) & ~uintptr_t(3u));
    for (int i = 0; i < componentInfo->Count; ++i)
...
// ?GetTrajectory@?$nalComponent@VnalComponentFloat1Base@@VnalComponentEntropyFloat1Data@@VnalComponentEntropyFloat1@@@@UBEXAAVnalComponentEnum@@PAX_NPBH@Z
// (nal_init.o 0x857460)
template <>
void nalComponent<nalComponentFloat1Base,
                  nalComponentEntropyFloat1Data,
                  nalComponentEntropyFloat1>::GetTrajectory(
    nalComponentEnum& componentEnum, void* dst, bool trajabs,
    const int* offsetTable) const
{
    (void)dst;
...
void FastCycleTrajectory<
    nalComponentEntropyFloat1, float,
    nalComponentData::SkeletonData,
    nalComponentEntropyFloat1Data::AnimData,
    nalComponentEntropyFloat1Data::SkeletonComponentData,
...
// ??$FastCycleTrajectory@VnalComponentPacked8Float1@@MUSkeletonData@nalComponentData@@UAnimData@3@USkeletonComponentData@nalComponentPacked8Float1Data@@UAnimComponentData@3@@@YAXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x8651d0)
template <>
void FastCycleTrajectory<
    nalComponentPacked8Float1, float,
    nalComponentData::SkeletonData, nalComponentData::AnimData,
    nalComponentPacked8Float1Data::SkeletonComponentData,
    nalComponentData::AnimComponentData>(
    nalComponentEnum& componentEnum, void* ptr, void* prev, int cycle,
    bool trajabs, const int* offsetTable)
{
...
// ??$FastCycleTrajectory@VnalComponentFloat3@@VDir3@math@@USkeletonData@nalComponentData@@UAnimData@5@USkeletonComponentData@5@UAnimComponentData@5@@@YAXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x865270)
template <>
void FastCycleTrajectory<
    nalComponentFloat3, math::Dir3,
    nalComponentData::SkeletonData, nalComponentData::AnimData,
    nalComponentData::SkeletonComponentData,
    nalComponentData::AnimComponentData>(
    nalComponentEnum& componentEnum, void* ptr, void* prev, int cycle,
...
// ??$FastCycleTrajectory@VnalComponentEntropyFloat3@@VDir3@math@@USkeletonData@nalComponentData@@UAnimData@nalComponentEntropyFloat3Data@@USkeletonComponentData@7@UAnimComponentData@5@@@YAXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x865300)
template <>
void FastCycleTrajectory<
    nalComponentEntropyFloat3, math::Dir3,
    nalComponentData::SkeletonData,
    nalComponentEntropyFloat3Data::AnimData,
    nalComponentEntropyFloat3Data::SkeletonComponentData,
    nalComponentData::AnimComponentData>(
    nalComponentEnum& componentEnum, void* ptr, void* prev, int cycle,
    bool trajabs, const int* offsetTable)
{
...
// ?CycleTrajectory@?$nalComponent@VnalComponentFloat1Base@@VnalComponentEntropyFloat1Data@@VnalComponentEntropyFloat1@@@@UBEXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x8650f0)
template <>
void nalComponent<nalComponentFloat1Base,
                  nalComponentEntropyFloat1Data,
                  nalComponentEntropyFloat1>::CycleTrajectory(
    nalComponentEnum& componentEnum, void* ptr, void* prev, int cycle,
...
// ?CycleTrajectory@?$nalComponent@VnalComponentFloat1Base@@VnalComponentPacked8Float1Data@@VnalComponentPacked8Float1@@@@UBEXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x8651a0)
template <>
void nalComponent<nalComponentFloat1Base,
                  nalComponentPacked8Float1Data,
                  nalComponentPacked8Float1>::CycleTrajectory(
    nalComponentEnum& componentEnum, void* ptr, void* prev, int cycle,
    bool trajabs, const int* offsetTable) const
{
    FastCycleTrajectory<
...
// ?CycleTrajectory@?$nalComponent@VnalComponentFloat3Base@@VnalComponentFloat3Data@@VnalComponentFloat3@@@@UBEXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x865240)
template <>
void nalComponent<nalComponentFloat3Base,
                  nalComponentFloat3Data,
                  nalComponentFloat3>::CycleTrajectory(
    nalComponentEnum& componentEnum, void* ptr, void* prev, int cycle,
    bool trajabs, const int* offsetTable) const
{
    FastCycleTrajectory<
...
// ?CycleTrajectory@?$nalComponent@VnalComponentFloat3Base@@VnalComponentEntropyFloat3Data@@VnalComponentEntropyFloat3@@@@UBEXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x8652d0)
template <>
void nalComponent<nalComponentFloat3Base,
                  nalComponentEntropyFloat3Data,
                  nalComponentEntropyFloat3>::CycleTrajectory(
    nalComponentEnum& componentEnum, void* ptr, void* prev, int cycle,
    bool trajabs, const int* offsetTable) const
{
    FastCycleTrajectory<
...
// ??$FastCycleTrajectory@VnalComponentPacked8EntropyFloat3@@VDir3@math@@USkeletonData@nalComponentData@@UAnimData@nalComponentPacked8EntropyFloat3Data@@USkeletonComponentData@7@UAnimComponentData@5@@@YAXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x8653b0)
template <>
void FastCycleTrajectory<
    nalComponentPacked8EntropyFloat3, math::Dir3,
    nalComponentData::SkeletonData,
...
// ??$FastCycleTrajectory@VnalComponentPacked16EntropyFloat3@@VDir3@math@@USkeletonData@nalComponentData@@UAnimData@nalComponentPacked16EntropyFloat3Data@@USkeletonComponentData@7@UAnimComponentData@5@@@YAXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x865460)
template <>
void FastCycleTrajectory<
    nalComponentPacked16EntropyFloat3, math::Dir3,
    nalComponentData::SkeletonData,
    nalComponentPacked16EntropyFloat3Data::AnimData,
    nalComponentPacked16EntropyFloat3Data::SkeletonComponentData,
    nalComponentData::AnimComponentData>(
    nalComponentEnum& componentEnum, void* ptr, void* prev, int cycle,
    bool trajabs, const int* offsetTable)
{
...
// ??$FastCycleTrajectory@VnalComponentFloat4@@VVector4@math@@USkeletonData@nalComponentData@@UAnimData@5@USkeletonComponentData@5@UAnimComponentData@5@@@YAXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x865510)
template <>
void FastCycleTrajectory<
    nalComponentFloat4, math::Vector4,
    nalComponentData::SkeletonData, nalComponentData::AnimData,
    nalComponentData::SkeletonComponentData,
    nalComponentData::AnimComponentData>(
    nalComponentEnum& componentEnum, void* ptr, void* prev, int cycle,
...
// ??$FastCycleTrajectory@VnalComponentEntropyFloat4@@VVector4@math@@USkeletonData@nalComponentData@@UAnimData@nalComponentEntropyFloat4Data@@USkeletonComponentData@7@UAnimComponentData@5@@@YAXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x8655c0)
template <>
void FastCycleTrajectory<
    nalComponentEntropyFloat4, math::Vector4,
    nalComponentData::SkeletonData,
    nalComponentEntropyFloat4Data::AnimData,
    nalComponentEntropyFloat4Data::SkeletonComponentData,
    nalComponentData::AnimComponentData>(
    nalComponentEnum& componentEnum, void* ptr, void* prev, int cycle,
    bool trajabs, const int* offsetTable)
...
// ?CycleTrajectory@?$nalComponent@VnalComponentFloat3Base@@VnalComponentPacked8EntropyFloat3Data@@VnalComponentPacked8EntropyFloat3@@@@UBEXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x865380)
template <>
void nalComponent<nalComponentFloat3Base,
                  nalComponentPacked8EntropyFloat3Data,
                  nalComponentPacked8EntropyFloat3>::CycleTrajectory(
    nalComponentEnum& componentEnum, void* ptr, void* prev, int cycle,
    bool trajabs, const int* offsetTable) const
{
    FastCycleTrajectory<
...
// ?CycleTrajectory@?$nalComponent@VnalComponentFloat3Base@@VnalComponentPacked16EntropyFloat3Data@@VnalComponentPacked16EntropyFloat3@@@@UBEXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x865430)
template <>
void nalComponent<nalComponentFloat3Base,
                  nalComponentPacked16EntropyFloat3Data,
                  nalComponentPacked16EntropyFloat3>::CycleTrajectory(
    nalComponentEnum& componentEnum, void* ptr, void* prev, int cycle,
    bool trajabs, const int* offsetTable) const
{
    FastCycleTrajectory<
...
// ?CycleTrajectory@?$nalComponent@VnalComponentFloat4Base@@VnalComponentFloat4Data@@VnalComponentFloat4@@@@UBEXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x8654e0)
template <>
void nalComponent<nalComponentFloat4Base,
                  nalComponentFloat4Data,
                  nalComponentFloat4>::CycleTrajectory(
    nalComponentEnum& componentEnum, void* ptr, void* prev, int cycle,
    bool trajabs, const int* offsetTable) const
{
    FastCycleTrajectory<
...
// ?CycleTrajectory@?$nalComponent@VnalComponentFloat4Base@@VnalComponentEntropyFloat4Data@@VnalComponentEntropyFloat4@@@@UBEXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x865590)
template <>
void nalComponent<nalComponentFloat4Base,
                  nalComponentEntropyFloat4Data,
                  nalComponentEntropyFloat4>::CycleTrajectory(
    nalComponentEnum& componentEnum, void* ptr, void* prev, int cycle,
    bool trajabs, const int* offsetTable) const
{
    FastCycleTrajectory<
...
// ??$FastCycleTrajectory@VnalComponentPacked8EntropyFloat4@@VVector4@math@@USkeletonData@nalComponentData@@UAnimData@nalComponentPacked8EntropyFloat4Data@@USkeletonComponentData@7@UAnimComponentData@5@@@YAXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x865660)
template <>
void FastCycleTrajectory<
    nalComponentPacked8EntropyFloat4, math::Vector4,
    nalComponentData::SkeletonData,
    nalComponentPacked8EntropyFloat4Data::AnimData,
    nalComponentPacked8EntropyFloat4Data::SkeletonComponentData,
    nalComponentData::AnimComponentData>(
    nalComponentEnum& componentEnum, void* ptr, void* prev, int cycle,
    bool trajabs, const int* offsetTable)
...
// ??$FastCycleTrajectory@VnalComponentPacked16EntropyFloat4@@VVector4@math@@USkeletonData@nalComponentData@@UAnimData@nalComponentPacked16EntropyFloat4Data@@USkeletonComponentData@7@UAnimComponentData@5@@@YAXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x865710)
template <>
void FastCycleTrajectory<
    nalComponentPacked16EntropyFloat4, math::Vector4,
    nalComponentData::SkeletonData,
    nalComponentPacked16EntropyFloat4Data::AnimData,
    nalComponentPacked16EntropyFloat4Data::SkeletonComponentData,
    nalComponentData::AnimComponentData>(
    nalComponentEnum& componentEnum, void* ptr, void* prev, int cycle,
    bool trajabs, const int* offsetTable)
...
// ??$FastCycleTrajectory@VnalComponentQuat@@VQuaternion@math@@USkeletonData@nalComponentData@@UAnimData@5@USkeletonComponentData@5@UAnimComponentData@5@@@YAXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x865800)
template <>
void FastCycleTrajectory<
    nalComponentQuat, math::Quaternion,
    nalComponentData::SkeletonData, nalComponentData::AnimData,
    nalComponentData::SkeletonComponentData,
    nalComponentData::AnimComponentData>(
    nalComponentEnum& componentEnum, void* ptr, void* prev, int cycle,
...
// ??$FastCycleTrajectory@VnalComponentEntropyQuat@@VQuaternion@math@@USkeletonData@nalComponentData@@UAnimData@nalComponentEntropyQuatData@@USkeletonComponentData@7@UAnimComponentData@5@@@YAXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x865840)
template <>
void FastCycleTrajectory<
    nalComponentEntropyQuat, math::Quaternion,
    nalComponentData::SkeletonData,
...
// ?CycleTrajectory@?$nalComponent@VnalComponentFloat4Base@@VnalComponentPacked8EntropyFloat4Data@@VnalComponentPacked8EntropyFloat4@@@@UBEXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x865630)
template <>
void nalComponent<nalComponentFloat4Base,
                  nalComponentPacked8EntropyFloat4Data,
                  nalComponentPacked8EntropyFloat4>::CycleTrajectory(
    nalComponentEnum& componentEnum, void* ptr, void* prev, int cycle,
    bool trajabs, const int* offsetTable) const
{
    FastCycleTrajectory<
...
// ?CycleTrajectory@?$nalComponent@VnalComponentFloat4Base@@VnalComponentPacked16EntropyFloat4Data@@VnalComponentPacked16EntropyFloat4@@@@UBEXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x8656e0)
template <>
void nalComponent<nalComponentFloat4Base,
                  nalComponentPacked16EntropyFloat4Data,
                  nalComponentPacked16EntropyFloat4>::CycleTrajectory(
    nalComponentEnum& componentEnum, void* ptr, void* prev, int cycle,
    bool trajabs, const int* offsetTable) const
{
    FastCycleTrajectory<
...
// ?CycleTrajectory@?$nalComponent@VnalComponentQuatBase@@VnalComponentQuatData@@VnalComponentQuat@@@@UBEXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x865790)
template <>
void nalComponent<nalComponentQuatBase,
                  nalComponentQuatData,
                  nalComponentQuat>::CycleTrajectory(
    nalComponentEnum& componentEnum, void* ptr, void* prev, int cycle,
    bool trajabs, const int* offsetTable) const
{
    FastCycleTrajectory<
...
// ?CycleTrajectory@?$nalComponent@VnalComponentQuatBase@@VnalComponentEntropyQuatData@@VnalComponentEntropyQuat@@@@UBEXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x865810)
template <>
void nalComponent<nalComponentQuatBase,
                  nalComponentEntropyQuatData,
                  nalComponentEntropyQuat>::CycleTrajectory(
    nalComponentEnum& componentEnum, void* ptr, void* prev, int cycle,
    bool trajabs, const int* offsetTable) const
{
    FastCycleTrajectory<
...
template <>
void FastCycleTrajectory<
    nalComponentPO, nalPositionOrientation,
    nalComponentData::SkeletonData, nalComponentData::AnimData,
    nalComponentData::SkeletonComponentData,
    nalComponentData::AnimComponentData>(
    nalComponentEnum& componentEnum, void* ptr, void* prev, int cycle,
...
// ??$FastCycleTrajectory@VnalComponentEntropyPO@@VnalPositionOrientation@@USkeletonData@nalComponentData@@UAnimData@nalComponentEntropyPOData@@USkeletonComponentData@6@UAnimComponentData@4@@@YAXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x8669a0)
template <>
void FastCycleTrajectory<
    nalComponentEntropyPO, nalPositionOrientation,
    nalComponentData::SkeletonData,
...
// ??$FastCycleTrajectory@VnalComponentPacked16EntropyIKSpin@@VnalIKSpin@@USkeletonData@nalComponentData@@UAnimData@nalComponentPacked16EntropyIKSpinData@@USkeletonComponentData@6@UAnimComponentData@6@@@YAXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x866d10)
template <>
void FastCycleTrajectory<
    nalComponentPacked16EntropyIKSpin, nalIKSpin,
    nalComponentData::SkeletonData,
...
// ?CycleTrajectory@?$nalComponent@VnalComponentPOBase@@VnalComponentPOData@@VnalComponentPO@@@@UBEXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x866900)
template <>
void nalComponent<nalComponentPOBase,
                  nalComponentPOData,
                  nalComponentPO>::CycleTrajectory(
    nalComponentEnum& componentEnum, void* ptr, void* prev, int cycle,
    bool trajabs, const int* offsetTable) const
{
    FastCycleTrajectory<
...
// ?CycleTrajectory@?$nalComponent@VnalComponentPOBase@@VnalComponentEntropyPOData@@VnalComponentEntropyPO@@@@UBEXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x866970)
template <>
void nalComponent<nalComponentPOBase,
                  nalComponentEntropyPOData,
                  nalComponentEntropyPO>::CycleTrajectory(
    nalComponentEnum& componentEnum, void* ptr, void* prev, int cycle,
    bool trajabs, const int* offsetTable) const
{
    FastCycleTrajectory<
...
// ?CycleTrajectory@?$nalComponent@VnalComponentIKSpinBase@@VnalComponentPacked16EntropyIKSpinData@@VnalComponentPacked16EntropyIKSpin@@@@UBEXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x866ce0)
template <>
void nalComponent<nalComponentIKSpinBase,
                  nalComponentPacked16EntropyIKSpinData,
                  nalComponentPacked16EntropyIKSpin>::CycleTrajectory(
    nalComponentEnum& componentEnum, void* ptr, void* prev, int cycle,
    bool trajabs, const int* offsetTable) const
{
    FastCycleTrajectory<
...
void nalComponent<nalComponentIKSpinBase,
                  nalComponentPacked16EntropyIKSpinData,
                  nalComponentPacked16EntropyIKSpin>::Delete(
    const nalGeneric::nalComponentInfo* componentInfo, void*& ptr) const
{
    ptr = (void*)(((uintptr_t)ptr + 15u) & ~uintptr_t(15u));
    for (int i = 0; i < componentInfo->Count; ++i)
...
template <typename TRACK, typename X, typename SKELETON_DATA,
          typename ANIM_DATA, typename SKELETON_COMPONENT_DATA,
          typename ANIM_COMPONENT_DATA>
void SlowCycleTrajectory(nalComponentEnum& componentEnum, void* ptr,
                         void* prev, int cycle, bool trajabs,
                         const int* offsetTable);

// ??$SlowCycleTrajectory@VnalComponentTrajectoryPO@@VnalPositionOrientation@@USkeletonData@nalComponentData@@UAnimData@4@USkeletonComponentData@4@UAnimComponentData@nalComponentTrajectoryPOData@@@@YAXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x8633B0)
template <>
void SlowCycleTrajectory<
    nalComponentTrajectoryPO, nalPositionOrientation,
    nalComponentData::SkeletonData, nalComponentData::AnimData,
    nalComponentData::SkeletonComponentData,
    nalComponentTrajectoryPOData::AnimComponentData>(
    nalComponentEnum& componentEnum, void* ptr, void* prev, int cycle,
    bool trajabs, const int* offsetTable)
{
    const void** customAnimData = componentEnum.CustomAnimData;
    ...
    nalComponentData::AnimData* animData =
        (nalComponentData::AnimData*)*customAnimData;
    *customAnimData = (const void*)(((uintptr_t)*customAnimData + 15u)
                                    & ~uintptr_t(15u));
    nalComponentTrajectoryPOData::AnimComponentData** animComponentData =
        (nalComponentTrajectoryPOData::AnimComponentData**)customAnimData;
    const nalGeneric::nalComponentInfo* componentInfo =
        componentEnum.ComponentInfo;
    for (int i = 0; i < componentInfo->Count; ++i)
    {
        ...
        if (offsetTable[track] >= 0)
        {
            ...
            {
                const int offset = offsetTable[track];
                nalComponentTrajectoryPO::ComponentCycleTrajectory(
                    (nalPositionOrientation*)((char*)ptr + offset),
                    (nalPositionOrientation*)((char*)prev + offset), cycle,
                    skeletonData, animData,
                    (nalComponentData::SkeletonComponentData*)skeletonData,
                    *animComponentData,
                    trajabs);
            }
        }
...
// ??$SlowCycleTrajectory@VnalComponentEntropyTrajectoryPO@@VnalPositionOrientation@@USkeletonData@nalComponentData@@UAnimData@nalComponentEntropyTrajectoryPOData@@USkeletonComponentData@6@UAnimComponentData@6@@@YAXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x8642F0)
template <>
void SlowCycleTrajectory<
    nalComponentEntropyTrajectoryPO, nalPositionOrientation,
    nalComponentData::SkeletonData,
    ...
    *customAnimData = (const void*)(((uintptr_t)*customAnimData + 15u)
    ...
    for (int i = 0; i < componentInfo->Count; ++i)
    {
        ...
        if (offsetTable[track] >= 0)
        {
            ...
            {
                const int offset = offsetTable[track];
                nalComponentEntropyTrajectoryPO::ComponentCycleTrajectory(
                    (nalPositionOrientation*)((char*)ptr + offset),
                    (nalPositionOrientation*)((char*)prev + offset), cycle,
                    skeletonData, animData,
                    (nalComponentEntropyTrajectoryPOData::SkeletonComponentData*)
                        *customSkeletonData,
                    *animComponentData, trajabs);
            }
        }
...
// ?CycleTrajectory@?$nalComponent@VnalComponentPOBase@@VnalComponentTrajectoryPOData@@VnalComponentTrajectoryPO@@@@UBEXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x863380)
template <>
void nalComponent<nalComponentPOBase,
                  nalComponentTrajectoryPOData,
                  nalComponentTrajectoryPO>::CycleTrajectory(
    nalComponentEnum& componentEnum, void* ptr, void* prev, int cycle,
    bool trajabs, const int* offsetTable) const
{
    SlowCycleTrajectory<
...
// ?CycleTrajectory@?$nalComponent@VnalComponentPOBase@@VnalComponentEntropyTrajectoryPOData@@VnalComponentEntropyTrajectoryPO@@@@UBEXAAVnalComponentEnum@@PAX1H_NPBH@Z
// (nal_init.o 0x8642C0)
template <>
void nalComponent<nalComponentPOBase,
                  nalComponentEntropyTrajectoryPOData,
                  nalComponentEntropyTrajectoryPO>::CycleTrajectory(
    nalComponentEnum& componentEnum, void* ptr, void* prev, int cycle,
    bool trajabs, const int* offsetTable) const
{
    SlowCycleTrajectory<
...
// Layout verified vs disasm: mMetaNalBaseAnimPtr[2] +0x1A0, mMetaAnimDataPtr[2]
// +0x1A8, mSlipAnim +0x1B0, mMode +0x1B4, mInputProgress +0x1B8,
...
// ============================================================================
class InteractStateRowboat : public InteractState {
public:
    enum EMode {
        MODE_IDLE = 0,
        MODE_ROW = 1,
    ...
    InteractStateRowboat(TPakId curPakId, const InteractStateInfo* info,
                         InteractionController* controller);

    void* mMetaNalBaseAnimPtr[2];   // +0x1A0
    void* mMetaAnimDataPtr[2];      // +0x1A8
    void* mSlipAnim;                // +0x1B0
    EMode mMode;                    // +0x1B4
    ...
    void SetRowboatFlag(unsigned int f, int enable);  // ?SetRowboatFlag@InteractStateRowboat@@QAEXIH@Z
    static void GiveOrder(int orderHash, float strokeDuration,
                          float bestThreshold, float okayThreshold,
                          float lateThreshold);       // ?GiveOrder@...@@SAXHMMMM@Z

private:
    // Binary mangles these as AAE (private); keep access matching.
    void StartModeIdle();    // ?StartModeIdle@...@@AAEXXZ
    void StartModeRow();     // ?StartModeRow@...@@AAEXXZ
    void StartModeSlip();    // ?StartModeSlip@...@@AAEXXZ
    void UpdateNotify(float deltaT);  // ?UpdateNotify@...@@AAEXM@Z
    void NewStroke();        // ?NewStroke@...@@AAEXXZ
    void StartMode(EMode newMode);    // ?StartMode@...@@AAEXW4EMode@1@@Z
    EMode UpdateModeIdle(float deltaT);  // ?UpdateModeIdle@...@@AAE?AW4EMode@1@M@Z
    void PlayRowingMetaAnim(int index);  // ?PlayRowingMetaAnim@...@@AAEXH@Z
    EMode UpdateModeSlip(float deltaT);  // ?UpdateModeSlip@...@@AAE?AW4EMode@1@M@Z
    void UpdateUI(float deltaT);         // ?UpdateUI@...@@AAEXM@Z
...
int InteractionController::GetInteractWeaponIndex() const
{
    ...
    if (result < 1)
    {
        ...
        if (Player != nullptr && Player->client != nullptr)
            return *(int*)((char*)Player->client + 0xA4);
        return 0;
    }
    return result;
}
...
// ============================================================================
// InteractState/InputRcvr update+press cluster (anim.o; smallest-first)
// ============================================================================

// ea: 0x0053C7E0
float InteractInputRcvr::Update(float deltaT)
{
    float v3 = deltaT + mTimer;
    mTimer = v3;
    if (v3 > ((InteractStateInfoLocal*)mInfo)->acceptInputMinTime)
        MeasureInput(mInputRate, mInputProgress, deltaT);
    return mInputRate;
}

// ea: 0x0053C820 / 0x0053C840
int InteractInputRcvr::Press(int buttonIndex)
{
    return buttonIndex != 27 && buttonIndex != 9;
}

int InteractInputRcvr::Release(int buttonIndex)
{
    return buttonIndex != 27 && buttonIndex != 9;
}

// ea: 0x0053A910
void InteractInputRcvr::Deactivate()
{
}

// ea: 0x0053C530
void InteractInputRcvr::InitInputRcvrArray()
{
    for (int i = 0; i < kInputTypeCount; ++i)
        sInputRcvrs[i] = nullptr;
}

// ea: 0x0053D860 / 0x0053D8B0
int InteractState::Press(int buttonIndex)
{
    InteractStateInfoLocal* info = (InteractStateInfoLocal*)mInfo;
    if (*(int*)((char*)info + 0x370) != 0 && buttonIndex == 211)
        return 0;
    InteractInputRcvr* rcvr = (InteractInputRcvr*)mInputRcvr;
    if (rcvr != nullptr)
        return rcvr->Press(buttonIndex);
    return buttonIndex != 27 && buttonIndex != 9;
}

int InteractState::Release(int buttonIndex)
{
    InteractStateInfoLocal* info = (InteractStateInfoLocal*)mInfo;
    if (*(int*)((char*)info + 0x370) != 0 && buttonIndex == 211)
        return 0;
    InteractInputRcvr* rcvr = (InteractInputRcvr*)mInputRcvr;
    if (rcvr != nullptr)
        return rcvr->Release(buttonIndex);
    return buttonIndex != 27 && buttonIndex != 9;
}
...
// ea: 0x0053BFD0
void InteractionController::PostPhysicsUpdate(float deltaT)
{
    if (mCurState != nullptr)
        InteractState_PostPhysicsUpdate((InteractState*)mCurState, deltaT);
}

// ea: 0x0053C080 / 0x0053C0A0
int InteractionController::Press(int buttonIndex)
{
    if (mCurState != nullptr)
        return ((InteractState*)mCurState)->Press(buttonIndex);
    return 0;
}

int InteractionController::Release(int buttonIndex)
{
    if (mCurState != nullptr)
        return ((InteractState*)mCurState)->Release(buttonIndex);
    return 0;
}

// ============================================================================
// InteractMetaAnimData vtable methods (anim.o; smallest-first)
// ============================================================================

// ea: 0x0055FE20
int InteractMetaAnimData::IsDelayCreate()
{
    return 1;
}
...
// ea: 0x0053F840
int InteractMetaAnimData::IsAnimLooping() const
{
    if (mAnimPtr != nullptr)
        return *(unsigned int*)((char*)mAnimPtr + 0x34) & 1;
    return 0;
}

// ea: 0x0053F880
float InteractMetaAnimData::GetAnimDuration() const
{
    if (mAnimPtr != nullptr)
        return *(float*)((char*)mAnimPtr + 0x38);
    return 1.0f;
}

// ea: 0x0053F860
int InteractMetaAnimData::IsAnimTrajRelative() const
{
    return mAnimPtr == nullptr
           || (*(unsigned int*)((char*)mAnimPtr + 0x34) & 2) == 0;
}
...
// ============================================================================
// InteractState::PlayAnims + interactable anim-player creation (anim.o)
// ============================================================================

extern void DObjCreateAnimationPlayer(DObj* obj, int modelIndex);

// ea: 0x0054CA00
void InteractionController::CreateInteractableAnimPlayer()
{
    if ((mFlags & 2) != 0)
        return;
    unsigned int v1 = mInteractableH.mVal & 0xFFF;
    if (v1 < 0x540
               ...
               == EntityHandleDb::sInst.mElements[v1].mKey)
    {
        ...
        if (mObject != nullptr)
        {
            ...
            {
                mFlags |= 2u;
                for (int i = 0; i < mDObj->numModels; ++i)
                {
                    if (mDObj->animPlayers[i] != nullptr)
                    {
                        XANIM_ASSERT(
                            "!otherDObj->animPlayers[i]",
                            "c:\\cod\\code\\game\\InteractionController.cpp",
                            1466, "Anim player already created");
                    }
                    DObjCreateAnimationPlayer(mDObj, i);
                }
            }
        }
    }
...
// ea: 0x0054DC40
void InteractState::PlayAnims(int weaponIndex, float fadeIn)
{
    Entity* Player = EntityManager::sInst->GetPlayer(currCl);
    if (*(unsigned char*)((char*)Player->client + 0x9D8) != weaponIndex)
    {
        XANIM_ASSERT("player->client->ps.weapon == weaponIndex",
                     "c:\\cod\\code\\game\\InteractState.cpp", 949,
                     "Weapon needs to be set to selected index");
    }
    if (*(unsigned char*)((char*)Player->client + 0x9D8) == weaponIndex)
    {
        InteractStateInfoLocal* info = (InteractStateInfoLocal*)mInfo;
        ...
        if ((mFlags & 0x400) != 0)
        {
            ...
            if (animIndex != -1)
            {
                char* v9 = (char*)info + 40 * animIndex;
                playerAnim = v9 + 0xF8;
                interactableAnim = v9 + 0x238;
            }
        }
        ...
        {
            unsigned int v11 = mController->mInteractableH.mVal & 0xFFF;
            if (v11 < 0x540
                       ...
                       == EntityHandleDb::sInst.mElements[v11].mKey)
            {
                ...
                if (mObject != nullptr)
                {
                    tlFixedString name2(interactableAnim);
                    void* Anim2 = nalGetAnim(name2);
                    mOtherAnim = Anim2;
                    if (Anim2 != nullptr)
                    {
                        DObj* mDObj = mObject->mDObj;
                        if (mDObj != nullptr)
                        {
                            ...
                            mOtherCallback =
                                mController->GetNextOtherCallback();
                            for (int i = 0; i < mDObj->numModels; ++i)
                            {
                                if (mDObj->animPlayers[i] != nullptr)
                                {
                                    void* playMethod =
                                        mController->GetNextOtherPlayMethod();
        ...
        if (*weaponAnim != 0)
        {
            ...
            if (dobj != nullptr
                && *(unsigned char*)((char*)dobj + 0xCE) > 1
                && *(void**)((char*)dobj + 0x20) != nullptr)
            {
                tlFixedString name3(weaponAnim);
                void* Anim3 = nalGetAnim(name3);
                if (Anim3 != nullptr)
                {
                    ((AnimationPlayer*)*(void**)((char*)dobj + 0x20))
                        ->Play((nalGenericAnim*)Anim3, true, 0.0f, nullptr,
                               0.0f, nullptr, 1.0f, 0.0f);
                }
            }
        }
...
void InteractStateMeleeSuccess_PlayAnims(InteractState* self,
                                         int weaponIndex, float fadeIn)
{
    self->mFlags |= 0x400u;
    self->PlayAnims(weaponIndex, fadeIn);
}

void InteractStateMeleeFailure_PlayAnims(InteractState* self,
                                         int weaponIndex, float fadeIn)
{
    self->mFlags |= 0x400u;
    self->PlayAnims(weaponIndex, fadeIn);
...
// ea: 0x00556480
void InteractStateRowboat::HandleMortarFlinch()
{
...
// ea: 0x00556550
void InteractStateRowboat::ProcessOrder()
{
...
// ea: 0x0053ACE0
void InteractStateRowboat::SetRowboatFlag(unsigned int f, int enable)
{
    int* flags = (int*)&mRowboatFlags;
    if (enable != 0)
        *flags |= (int)f;
    else
        *flags &= ~(int)f;
...
// ea: 0x0053DE90
void InteractStateRowboat::GiveOrder(int orderHash, float strokeDuration,
                                     float bestThreshold, float okayThreshold,
                                     float lateThreshold)
{
...
void InteractStateRowboat::StartModeIdle()
{
    mStartAnim = 1;
}
...
// ea: 0x0053DF00
void InteractStateRowboat::StartModeSlip()
{
    mRowboatFlags |= 2;
    mStartAnim = 1;
    mFeedbackTimer = 3.0f;  // kRowboatFeedbackTime
}

// ea: 0x0053DF30
void InteractStateRowboat::UpdateNotify(float deltaT)
{
    (void)deltaT;
}

// ea: 0x0053DF40
void InteractStateRowboat::NewStroke()
{
    mStrokeTimer = 0.0f;
    float sStrokeDuration = *(float*)&sStrokeDurationRowboat;
    if (sStrokeDuration > 0.0f && mNumStrokes % 2 == 0)
        mCurStrokeDuration = sStrokeDuration;
}

// ea: 0x00540960
void InteractStateRowboat::StartMode(EMode newMode)
{
    mMode = newMode;
    if (newMode >= MODE_SLIP)
    {
        if (newMode == MODE_SLIP)
        {
            mRowboatFlags |= 2;
    ...
    mStartAnim = 1;
    int rumbleVal = mRumbleHandleVal;
    if (rumbleVal != -1)
    {
        RumbleManager* inst = (RumbleManager*)RumbleManager_Inst(currCl);
        if (inst != nullptr)
...
InteractStateRowboat::EMode InteractStateRowboat::UpdateModeIdle(float deltaT)
{
    ...
    if (mStartAnim != 0)
    {
            ...
            && mAnimFadeTimer <= 0.0f)
        {
            tlFixedString name(info->playerAnim);
            void* Anim = nalGetAnim(name);
            void* controller = this->mController;
            int weaponIndex =
                ((InteractionController*)controller)
...
// ============================================================================
// InteractionController lifecycle + weapon cluster (anim.o)
// ============================================================================

// Minimal weaponInfo_s view (full in cg_weapons.cpp)
struct weaponInfo_s {
...
class PlayerState;
extern int BG_GivePlayerWeapon(PlayerState* pPS, int iWeaponIndex);  // ?BG_GivePlayerWeapon@@YAHPAVPlayerState@@H@Z (g_bg_pmove.cpp)
...
extern hash_const_t hash_const;  // ?hash_const@@3Uhash_const_t@@A

// ea: 0x005554A0
void InteractionController::SetInteractableH(
    const DbLinkedHandle<EntityHandleDb, Entity>& handle)
{
    unsigned int mVal = mInteractableH.mVal;
    unsigned int v4 = mVal & 0xFFF;
    if (v4 < 0x540
        && mVal >> 12 == EntityHandleDb::sInst.mElements[v4].mKey
    ...
    mInteractableH.mVal = handle.mVal;
}

// ea: 0x0053BFF0
void InteractionController::ClearQueue()
{
    for (int i = 0; i < 10; ++i)
        mQueue[i].mInfoIndex = -1;
    mCurQueueSize = 0;
...
// ea: 0x0054C890
void InteractionController::FreeAllStates()
{
    void** mElements = (void**)mStates.mElements;
    for (int i = 0; i < mStates.mSize; ++i)
    {
        if (mElements[i] != nullptr)
            PakManager::sInst->MemFree(
                *(TPakId*)((char*)mElements[i] + 0x14), mElements[i], false);
    }
    mStates.mSize = 0;
}

// ea: 0x0054CB40
void InteractionController::PopActorInteractionState()
{
    unsigned int mVal = mInteractableH.mVal;
    unsigned int v2 = mVal & 0xFFF;
    if (v2 < 0x540
...
// ea: 0x0054CAE0
void InteractionController::FreeInteractableAnimPlayer()
{
    unsigned int mVal = mInteractableH.mVal;
    unsigned int v3 = mVal & 0xFFF;
    Entity* mObject = nullptr;
...
// ea: 0x0054C990
void InteractionController::SendResultNotify()
{
    unsigned int v1 = mInteractableH.mVal & 0xFFF;
    if (v1 < 0x540
        && mInteractableH.mVal >> 12
               == EntityHandleDb::sInst.mElements[v1].mKey)
    {
        ...
        if (mObject != nullptr)
        {
            ...
            if ((mFlags & 0x400) != 0)
                ...
                resultCode = (mFlags & 0x200) != 0;
            mObject->Notify(hash_const.interaction_done, resultCode);
        }
    }
}

// ea: 0x00546050
void InteractionController::SelectInteractionWeapon(int newIndex)
{
    Entity* Player = EntityManager::sInst->GetPlayer(mClient);
    if (newIndex > 0)
    {
        if (cg_weapons[newIndex].registered == 0)
            CG_RegisterWeapon(newIndex);
        BG_GivePlayerWeapon((PlayerState*)Player->client, newIndex);
        int weapon = *(int*)((char*)Player->client + 0xA4);
        if (weapon != newIndex)
        {
            if (mRestoreWeaponIndex == -1)
                mRestoreWeaponIndex = weapon;
            mPendingWeaponIndex = newIndex;
            ResetAnimationPlayer();
        }
        mSelectedInteractWeaponIndex = newIndex;
    }
}

// ea: 0x005460D0
void InteractionController::ForceInteractionWeapon(int newIndex)
{
    Entity* Player = EntityManager::sInst->GetPlayer(mClient);
    if (newIndex > 0)
    {
        int v5 = cg_aWeaponSelect[Player->GetPlayerIndex()];
        if (v5 != 0 && v5 != newIndex)
        {
            if (mRestoreWeaponIndex == -1)
                mRestoreWeaponIndex = v5;
            ResetAnimationPlayer();
        }
        if (cg_weapons[newIndex].registered == 0)
            CG_RegisterWeapon(newIndex);
        BG_GivePlayerWeapon((PlayerState*)Player->client, newIndex);
        *(int*)((char*)Player->client + 0xA4) = newIndex;
        *(int*)((char*)&cl[mClient] + 0x644) = newIndex;
        *(int*)((char*)&cl[mClient] + 0x688
                + 24 * (*(int*)((char*)&cl[mClient] + 0x1288) & 0x3F)
                + 0x08) = newIndex;
        BG_SelectWeaponIndex(newIndex, mClient);
        *(int*)((char*)Player->client + 0xA8) = 0;
        *(int*)((char*)Player->client + 0x34) = 0;
        ResetAnimationPlayer();
        mSelectedInteractWeaponIndex = newIndex;
    }
}
...
// ea: 0x0053C0C0
void InteractionController::RemoveInteractionWeapon()
{
    if (mRestoreWeaponIndex != -1)
    {
        Entity* Player = EntityManager::sInst->GetPlayer(mClient);
        if (Player != nullptr)
        {
            ...
            if (ps != nullptr)
            {
                *(int*)(ps + 0xA4) = mRestoreWeaponIndex;
                *(int*)((char*)&cl[mClient] + 0x644) = mRestoreWeaponIndex;
                *(int*)((char*)&cl[mClient] + 0x688
                        + 24 * (*(int*)((char*)&cl[mClient] + 0x1288) & 0x3F)
                        + 0x08) = mRestoreWeaponIndex;
                BG_SelectWeaponIndex(mRestoreWeaponIndex, mClient);
                *(int*)(ps + 0xA8) = 1;
                weaponFileInfo_t* InfoForWeapon =
                    BG_GetInfoForWeapon(*(int*)(ps + 0xA4));
                *(int*)(ps + 0x34) = *(int*)((char*)InfoForWeapon + 0x628);
...
// ae_vector<InteractState*>::push_back (0x5603F0; compiler-generated)
void InteractionController_StatesPushBack(InteractionController* self,
                                          InteractState* st)
{
    int mSize = self->mStates.mSize;
    if (mSize >= self->mStates.mCapacity)
    {
        int newCap = mSize + 4;
        if (mSize <= 3)
            newCap = mSize + 1;
        void** v5 = (void**)tlMemAlloc(4 * newCap, 8, 0);
        for (int i = 0; i < self->mStates.mSize; ++i)
            v5[i] = ((void**)self->mStates.mElements)[i];
        if (self->mStates.mElements != nullptr)
        {
            tlMemFree(self->mStates.mElements);
            self->mStates.mElements = nullptr;
            self->mStates.mCapacity = 0;
        }
        self->mStates.mElements = v5;
        self->mStates.mCapacity = newCap;
    }
    ((void**)self->mStates.mElements)[self->mStates.mSize++] = st;
}

extern void* sInteractionInfos[8];
extern int sNumInteractionInfos;
...
InteractState* InteractionController::CreateState(const char* stateName,
                                                  TPakId curPakId)
{
    InteractState* v4 = nullptr;
    if (*stateName != 0)
    {
        int v5 = 0;
        if (sNumInteractStateInfos > 0)
        {
            while (_stricmp((char*)sInteractStateInfos[v5], stateName) != 0)
            {
                if (++v5 >= sNumInteractStateInfos)
                    return v4;
            }
            if (v5 != -1)
            {
                void* v7 = sInteractStateInfos[v5];
                InteractState** mElements =
                    (InteractState**)mStates.mElements;
                InteractState** v8 = &mElements[mStates.mSize];
                if (mElements != v8)
                {
                    while ((*mElements)->mInfo != v7)
                    {
                        if (++mElements == v8)
                            break;
                    }
                ...
                int interactType = *(unsigned char*)((char*)v7 + 0x20);
                InteractState* state = nullptr;
                for (int i = 0; i < 25; ++i)
                {
                    if (kInteractStateCtors[i].mType == interactType)
                    {
                        state = (InteractState*)PakManager::sInst->MemAlloc(
                            curPakId, kInteractStateCtors[i].mSize, false);
                        if (state != nullptr)
                            kInteractStateCtors[i].ctor(state, curPakId, v7,
                                                        this);
                        break;
                    }
                }
                if (state == nullptr && interactType <= 0x18)
                {
                    XANIM_ASSERT(
                        ...
                        830, "Unknown InteractState type");
                }
                if (state != nullptr)
                {
                    InteractionController_StatesPushBack(this, state);
                    state->CreateTransitionStates();
                }
                return state;
            }
        }
...
// ea: 0x0054C8E0
void InteractionController::CreateInteraction(const char* name,
                                              TPakId curPakId)
{
    if (mInitialState != nullptr)
    {
        XANIM_ASSERT("mInitialState == 0",
                     "c:\\cod\\code\\game\\InteractionController.cpp", 915,
                     "Interaction already exists");
    }
    if (mInitialState == nullptr && sNumInteractionInfos > 0)
    {
        int v4 = 0;
        while (_stricmp((char*)sInteractionInfos[v4], name) != 0)
        {
            if (++v4 >= sNumInteractionInfos)
                return;
        }
        if (v4 != -1)
            mInitialState =
                CreateState((char*)sInteractionInfos[v4] + 0x20, curPakId);
    }
}

// ea: 0x0054CBA0
void InteractState::CreateTransitionStates()
{
    InteractStateInfoLocal* info = (InteractStateInfoLocal*)mInfo;
    for (int i = 0; i < 4; ++i)
    {
        char* successName = (char*)info + 0x28 + 0x20 * i;
        if (*successName != 0)
            mSuccessState[i] = mController->CreateState(successName, mPakId);
    }
...
void InteractStateRowboat::PlayRowingMetaAnim(int index)
{
    ...
    {
        InteractionController* c = this->mController;
...
// ea: 0x00547AA0
InteractStateRowboat::EMode InteractStateRowboat::UpdateModeSlip(float deltaT)
{
    (void)deltaT;
    if (mStartAnim != 0)
    {
        if (mAnimFadeTimer <= 0.0f)
        {
            float startAnimTimeFrac = mAnimScore;
    ...
    if (curAnim != nullptr && mSlipAnim == curAnim)
        return mMode;
    return MODE_IDLE;
}

// ea: 0x00540C40
void InteractStateRowboat::UpdateUI(float deltaT)
{
    ...
    else
    {
        ...
        mFeedbackTimer = feedbackTimer - deltaT;
    }
    char goodScore[32];
    sprintf(goodScore, "NUM STROKES: %i", mNumSuccessful);
    ...
    char badScore[32];
    sprintf(badScore, "NUM MISSES:  %i", mNumMisses);
...
// ea: 0x005476B0
InteractStateRowboat::EMode InteractStateRowboat::UpdateModeRow(float deltaT)
{
    EMode mMode = this->mMode;
    mRowboatFlags &= ~1u;
    if (mStartAnim != 0)
    {
        if (mAnimFadeTimer <= 0.0f)
        {
            PlayRowingMetaAnim(mRowAnimIndex);
            mStartAnim = 0;
            mFinishStroke = 0;
            mAnimScore = 0.0f;
            mStallTimer = 0.0f;
    ...
    if (mStartAnim == 0)
    {
        ...
        if ((rcvr->mFlags & 4) != 0)
            return MODE_SLIP;
        float inputProgress = mInputProgress;
        if ((rcvr->mFlags & 8) != 0)
            mFinishStroke = 1;
        if (mFinishStroke != 0)
            inputProgress = inputProgress + 1.0f;
        if (inputProgress > mAnimScore)
        {
            mStallTimer = 0.0f;
            float v8 = inputProgress - mAnimScore;
            float v9 = sMaxRowSpeed * deltaT;
            if (v9 > v8)
                v9 = v8;
            float prevScore = mAnimScore;
            mAnimScore = v9 + mAnimScore;
            if (prevScore < sSplashFXAnimScoreMin
                && mAnimScore >= sSplashFXAnimScoreMin)
            {
                Entity* Player = EntityManager::sInst->GetPlayer(currCl);
        ...
        {
            if (mLastInputProgress >= inputProgress)
            {
                mStallTimer += deltaT;
                    ...
                    || sProgressHoldMax <= inputProgress)
                {
                    ...
                    {
                        mAnimScore += sStallAdvanceSpeed * deltaT;
                    }
                    else
                    {
                        ...
                        if ((mAnimScore > sAnimScoreSlipMin
                             && sAnimScoreSlipMax > mAnimScore)
                            || fabsf(stickY) > 1.0f
                            || fabsf(stickX) > 1.0f)
                            mMode = MODE_SLIP;
                        else
        ...
        if (mMode == this->mMode)
        {
            ...
            this->mController->mMetaAnimScore = mAnimScore;
        }
        int inScore = mAnimScore > sRumbleScoreMin
                      && sRumbleScoreMax > mAnimScore;
