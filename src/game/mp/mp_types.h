...
void WriteEntryPoint(bdReference<bdBitBuffer> buffer, int entryIdx);    // ?WriteEntryPoint@MPUtility@@YAXV?$bdReference@VbdBitBuffer@@@@H@Z (mp.o 0x73C050)
    ...
    bool ReadPosition(bdReference<bdBitBuffer> buffer, float* const position);  // ?ReadPosition@MPUtility@@YA_NV?$bdReference@VbdBitBuffer@@@@QAM@Z (mp.o 0x73ACA0)
    void WriteNormal(bdReference<bdBitBuffer> buffer, const float* const normal);  // ?WriteNormal@MPUtility@@YAXV?$bdReference@VbdBitBuffer@@@@QBM@Z (mp.o 0x73AFB0)
    ...
    void WritePosition(bdReference<bdBitBuffer> buffer, const float* const position);  // ?WritePosition@MPUtility@@YAXV?$bdReference@VbdBitBuffer@@@@QBM@Z (mp.o 0x...)
    ...
    void WriteAnglesYawPitch(bdReference<bdBitBuffer> buffer, const float* const angles);  // ?WriteAnglesYawPitch@MPUtility@@YAXV?$bdReference@VbdBitBuffer@@@@QBM@Z (mp.o 0x...)
...
void WritePlayerTeam(bdReference<bdBitBuffer> buffer, team_t team);      // ?WritePlayerTeam@MPUtility@@YAXV?$bdReference@VbdBitBuffer@@@@W4team_t@@@Z (mp.o 0x73C200)
    void WriteCompressedVector(bdReference<bdBitBuffer> buffer, const float* const vec);  // ?WriteCompressedVector@MPUtility@@YAXV?$bdReference@VbdBitBuffer@@@@QBM@Z (mp.o 0x73B600)
    void WriteVector(bdReference<bdBitBuffer> buffer, const float* const vec);    // ?WriteVector@MPUtility@@YAXV?$bdReference@VbdBitBuffer@@@@QBM@Z (mp.o 0x73B400)
    void WriteAngles(bdReference<bdBitBuffer> buffer, const float* const angles); // ?WriteAngles@MPUtility@@YAXV?$bdReference@VbdBitBuffer@@@@QBM@Z (mp.o 0x73B120)
    ...
    bool ReadVector(bdReference<bdBitBuffer> buffer, float* const vec);  // ?ReadVector@MPUtility@@YA_NV?$bdReference@VbdBitBuffer@@@@QAM@Z (mp.o 0x73B4D0)
    bool ReadAngles(bdReference<bdBitBuffer> buffer, float* const angles);  // ?ReadAngles@MPUtility@@YA_NV?$bdReference@VbdBitBuffer@@@@QAM@Z (mp.o 0x73B2C0)
    bool ReadAnglesYawPitch(bdReference<bdBitBuffer> buffer, float* const angles);  // ?ReadAnglesYawPitch@MPUtility@@YA_NV?$bdReference@VbdBitBuffer@@@@QAM@Z (mp.o 0x...)
    bool ReadNormal(bdReference<bdBitBuffer> buffer, float* const normal);  // ?ReadNormal@MPUtility@@YA_NV?$bdReference@VbdBitBuffer@@@@QAM@Z (mp.o 0x73B090)
    ...
    bool ReadSnappedPosition(bdReference<bdBitBuffer> buffer, float* const position);  // ?ReadSnappedPosition@MPUtility@@YA_NV?$bdReference@VbdBitBuffer@@@@QAM@Z (mp.o 0x73AEB0)
    ...
    void WriteSnappedPosition(bdReference<bdBitBuffer> buffer,
                              const float* const position);  // ?WriteSnappedPosition@MPUtility@@YAXV?$bdReference@VbdBitBuffer@@@@QBM@Z (mp.o 0x73AD70)
...
bool ReadCompressedVector(bdReference<bdBitBuffer> buffer, float* const vec);  // ?ReadCompressedVector@MPUtility@@YA_NV?$bdReference@VbdBitBuffer@@@@QAM@Z (mp.o 0x73B770)
...
int TotalScoreForStats(short* const stats);  // ?TotalScoreForStats@PlayerStats@@YAHQAF@Z (mp.o 0x7346D0)
