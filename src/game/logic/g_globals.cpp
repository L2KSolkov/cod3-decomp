...
int gRenderCG_2D = 1;            // ?gRenderCG_2D@@3HA (g.o)
...
int gRenderWorld = 1;            // ?gRenderWorld@@3HA (g.o)
int gRenderEntities = 1;         // ?gRenderEntities@@3HA (g.o)
int gRenderInstanceGroups = 1;   // ?gRenderInstanceGroups@@3HA (g.o)
int gRenderLightGlows = 1;       // ?gRenderLightGlows@@3HA (g.o)
int gRenderFX = 1;               // ?gRenderFX@@3HA (g.o)
int gRenderSky = 1;              // ?gRenderSky@@3HA (g.o)
int gRenderLocalEntities = 1;    // ?gRenderLocalEntities@@3HA (g.o)
int gRenderStatusBar = 1;        // ?gRenderStatusBar@@3HA (g.o)
int gRenderDebug = 1;             // ?gRenderDebug@@3HA (g.o)
...
cspField_t s_vehicleFields[73] = {  // ?s_vehicleFields@@3PAUcspField_t@@A (g.o @ 0xDD6EF0)
    { "type", 32, 8 },
    { "subtype", 34, 9 },
    { "vehiclePhysics", 540, 0 },
    { "vehiclePhysicsThird", 572, 0 },
    { "vehicleSndTopSpeed", 500, 6 },
    { "vehicleSndTopSpeedReverse", 504, 6 },
    { "vehicleCurveFile", 508, 0 },
    { "mantleHintString", 604, 0 },
    { "steerWheels", 36, 5 },
    { "quadBarrel", 44, 5 },
    { "bulletDamage", 48, 6 },
    { "grenadeDamage", 52, 6 },
    { "mineDamage", 56, 6 },
    { "projectileDamage", 60, 6 },
    { "spClientSeat", 64, 4 },
    { "hudIndex", 72, 4 },
    { "numSeats", 68, 4 },
    { "health", 128, 4 },
    { "texureScroll", 40, 6 },
    { "texureScrollScale", 76, 6 },
    { "engineSndSpeed", 392, 6 },
    { "maxSpeed", 80, 6 },
    { "accel", 84, 6 },
    { "rotRate", 88, 6 },
    { "rotAccel", 92, 6 },
    { "collisionDamage", 104, 6 },
    { "collisionSpeed", 108, 6 },
    { "suspensionTravel", 112, 6 },
    { "maxBodyPitch", 96, 6 },
    { "maxBodyRoll", 100, 6 },
    { "boundsRadius", 116, 6 },
    { "boundsHeight", 120, 6 },
    { "boundsLength", 124, 6 },
    { "turretWeapon", 132, 0 },
    { "turretAltWeapon", 164, 0 },
    { "turretAltModel", 196, 0 },
    { "turretGunnerWeapon", 228, 0 },
    { "turretGunnerModel", 260, 0 },
    { "turretGunnerBaseModel", 292, 0 },
    { "turretHorizSpanLeft", 356, 6 },
    { "turretHorizSpanRight", 360, 6 },
    { "turretVertSpanUp", 364, 6 },
    { "turretVertSpanDown", 368, 6 },
    { "turretRotRate", 372, 6 },
    { "turretSwirlLerpRate", 376, 6 },
    { "turretSwirlPitchFactor", 380, 6 },
    { "turretGunnerVertSpanUp", 384, 6 },
    { "turretGunnerVertSpanDown", 388, 6 },
    { "cameraZOffset", 432, 6 },
    { "cameraFPHeightOffset", 436, 6 },
    { "cameraFPFwdOffset", 440, 6 },
    { "cameraFPHeightLerp", 444, 6 },
    { "cameraChaseOffsetX", 448, 6 },
    { "cameraChaseOffsetY", 452, 6 },
    { "cameraChaseOffsetZ", 456, 6 },
    { "cameraChaseRadiusInner", 460, 6 },
    { "cameraChaseRadiusOuter", 464, 6 },
    { "cameraVehViewRadius", 468, 6 },
    { "cameraVehViewMaxPitch", 472, 6 },
    { "cameraVehViewMaxPitchDistAdj", 476, 6 },
    { "cameraVehViewFwdBackRatio", 480, 6 },
    { "cameraVehViewMoveInPitch", 484, 6 },
    { "camLinkedPitchFactor", 488, 6 },
    { "pitchBasedCamOffsetX", 492, 6 },
    { "pitchBasedCamOffsetZ", 496, 6 },
    { "vehicleAnimMatrixColumn", 640, 4 },
    { "playerInteractionFile", 644, 0 },
    { "playerEIName", 676, 0 },
    { "hatchOpenAngleRight", 708, 6 },
    { "hatchOpenAngleLeft", 712, 6 },
    { "driverIdleAnim", 716, 0 },
    { "nameOverlay", 748, 0 },
    { "inactiveBlowupSeconds", 780, 4 },
};
