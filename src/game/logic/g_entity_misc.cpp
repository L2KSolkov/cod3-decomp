...
void Camera_StartAnimating(void* self, float a)
{
    static_cast<Camera*>(self)->StartAnimating(a);
}
void Camera_StopAnimating(void* self, float a)
{
    static_cast<Camera*>(self)->StopAnimating(a);
}
struct CGBank;
