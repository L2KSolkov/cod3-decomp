...
const char* const szMPWeaponSplitScreenEntriesText[8] = {
...
const char* const szCreateSessionMenuSlotTextReferences[8] = {
    "MPFRONTEND_GAME_MODE_ALLCAPS", defaultFileName,
    "MPFRONTEND_MAP_NAME_ALLCAPS", defaultFileName,
    "MPFRONTEND_NUMBER_OF_PLAYERS_ALLCAPS", defaultFileName,
    "MPFRONTEND_PRIVATE_SLOTS_ALLCAPS", defaultFileName,
};
const char* const szCreateSessionMenuSlotText[8] = {
    "cg_slot_01_text_option", "cg_slot_01_text_spec",
    "cg_slot_02_text_option", "cg_slot_02_text_spec",
    "cg_slot_03_text_option", "cg_slot_03_text_spec",
    "cg_slot_04_text_option", "cg_slot_04_text_spec",
};
const char* const szCreateSessionMenuSlotGeometry[8] = {
    "cg_slot_01_arrow_left", "cg_slot_01_arrow_right",
    "cg_slot_02_arrow_left", "cg_slot_02_arrow_right",
    "cg_slot_03_arrow_left", "cg_slot_03_arrow_right",
    "cg_slot_04_arrow_left", "cg_slot_04_arrow_right",
};
const char* const szCreateSessionMenuTextReferences[4] = {
    "MPFRONTEND_PLAY_XBOX_LIVE", "MPFRONTEND_MM_CREATE_GAME",
    "MPFRONTEND_SELECT_GAME_CREATE_EXPLANATION",
    "MPFRONTEND_CREATE_GAME_HELP_BAR",
};
const char* const szCreateSessionMenuText[4] = {
    "cg_text_title_01", "cg_text_title_02",
    "cg_text_title_description", "text_helpbar",
};
const char* const szCreateSessionMenuBackgroundArt[6] = {
...
const char* const szCreateLanSessionAdvMenuBgRow[6] = {
    "bkg_row_01", "bkg_row_02", "bkg_row_03",
    "bkg_row_04", "bkg_row_05", "bkg_row_06",
};
const char* const szCreateLanSessionAdvMenuBgLine[5] = {
    "bkg_line_01", "bkg_line_02", "bkg_line_03",
    "bkg_line_04", "bkg_line_05",
};
const char* const szCreateLanSessionAdvMenuText[4] = {
    "text_title_01", "text_title_02",
    "text_title_description", "text_helpbar",
};
const char* const szCreateLanSessionAdvMenuTextRef[4] = {
    "MPFRONTEND_PLAY_SYSTEM_LINK",
    "MPFRONTEND_CREATEGAME_ADVANCED_OPTIONS",
    "MPFRONTEND_ADV_GAME_CREATE", "MPFRONTEND_HELP_SELECT_MOVEUD",
};
const char* const szCreateLanSessionAdvMenuSlotArrows[12] = {
    "slot_01_arrow_left", "slot_01_arrow_right",
    "slot_02_arrow_left", "slot_02_arrow_right",
    "slot_03_arrow_left", "slot_03_arrow_right",
    "slot_04_arrow_left", "slot_04_arrow_right",
...
const char* const szCreateLanSessionAdvMenuSlotText[12] = {
    "slot_01_text_option", "slot_01_text_spec",
    "slot_02_text_option", "slot_02_text_spec",
    "slot_03_text_option", "slot_03_text_spec",
    "slot_04_text_option", "slot_04_text_spec",
...
const char* const szCreateLanSessionAdvMenuSlotTextRef[12] = {
    "MPFRONTEND_TIME_LIMIT_ALLCAPS", defaultFileName,
    "MPFRONTEND_SCORE_LIMIT_ALLCAPS", defaultFileName,
    "MPFRONTEND_AUTO_TEAM_BALANCE_ALLCAPS", defaultFileName,
    "MPFRONTEND_TEAM_DAMAGE_ALLCAPS", defaultFileName,
...
const char* const szLanOnOff[2] = {
    "MPFRONTEND_OFF", "MPFRONTEND_ON",
};
const char* const szFindSessionMenuSlotText[10] = {
    "fg_slot_01_text_option", "fg_slot_01_text_spec",
    "fg_slot_02_text_option", "fg_slot_02_text_spec",
    "fg_slot_03_text_option", "fg_slot_03_text_spec",
    "fg_slot_04_text_option", "fg_slot_04_text_spec",
    "fg_slot_05_text_option", "fg_slot_05_text_spec",
};
const char* const szFindSessionMenuSlotTextReferences[10] = {
    "MPFRONTEND_GAME_MODE_ALLCAPS", defaultFileName,
    "MPFRONTEND_MAP_NAME_ALLCAPS", defaultFileName,
    "MPFRONTEND_NUMBER_OF_PLAYERS_ALLCAPS", defaultFileName,
    "MPFRONTEND_AUTO_TEAM_BALANCE_ALLCAPS", defaultFileName,
...
const char* const szFindSessionMenuText[4] = {
    "fg_text_title_01", "fg_text_title_02",
    "fg_text_title_description", "text_helpbar",
};
const char* const szFindSessionMenuTextReferences[4] = {
    "MPFRONTEND_PLAY_XBOX_LIVE", "MPFRONTEND_OPTIMATCH_ALLCAPS",
    "MPFRONTEND_SELECT_GAME_TYPE_EXPLANATION",
    "MPFRONTEND_HELP_BAR_FIND_GAME",
};
const char* const szFindSessionMenuBackgroundArt[6] = {
    "fg_bkg", "fg_bkg_detail_01", "fg_bkg_detail_02",
    "fg_bkg_detail_03", "fg_bkg_detail_04", "fg_bkg_detail_05",
};
const char* const szFindSessionMenuSlotGeometry[12] = {
    "fg_slot_01_arrow_left", "fg_slot_01_arrow_right",
    "fg_slot_02_arrow_left", "fg_slot_02_arrow_right",
    "fg_slot_03_arrow_left", "fg_slot_03_arrow_right",
    "fg_slot_04_arrow_left", "fg_slot_04_arrow_right",
    "fg_slot_05_arrow_left", "fg_slot_05_arrow_right",
    "fg_slot_06_arrow_left", "fg_slot_06_arrow_right",
};
const char* const szFindSessionBoolean[3] = {
    "MPFRONTEND_ANY", "MPFRONTEND_OFF", "MPFRONTEND_ON",
};
const char* const szFindLanSessionMenuSlotText[10] = {
    "fg_slot_01_text_option", "fg_slot_01_text_spec",
    "fg_slot_02_text_option", "fg_slot_02_text_spec",
    "fg_slot_03_text_option", "fg_slot_03_text_spec",
    "fg_slot_04_text_option", "fg_slot_04_text_spec",
...
const char* const szFindLanSessionMenuSlotTextReferences[10] = {
    "MPFRONTEND_GAME_MODE_ALLCAPS", defaultFileName,
    "MPFRONTEND_MAP_NAME_ALLCAPS", defaultFileName,
    "MPFRONTEND_NUMBER_OF_PLAYERS_ALLCAPS", defaultFileName,
    "MPFRONTEND_AUTO_TEAM_BALANCE_ALLCAPS", defaultFileName,
...
const char* const szFindLanSessionMenuText[4] = {
    "fg_text_title_01", "fg_text_title_02",
    "fg_text_title_description", "text_helpbar",
};
const char* const szFindLanSessionMenuTextReferences[4] = {
    "MPFRONTEND_PLAY_SYSTEM_LINK", "MPFRONTEND_FIND_GAME",
    "MPFRONTEND_SELECT_GAME_TYPE_EXPLANATION",
    "MPFRONTEND_HELP_BAR_FIND_GAME",
};
const char* const szFindLanSessionMenuBackgroundArt[4] = {
    "fg_bkg", "fg_bkg_detail_01", "fg_bkg_detail_02", "fg_bkg_detail_03",
};
const char* const szFindLanSessionMenuSlotGeometry[12] = {
    "fg_slot_01_arrow_left", "fg_slot_01_arrow_right",
    "fg_slot_02_arrow_left", "fg_slot_02_arrow_right",
    "fg_slot_03_arrow_left", "fg_slot_03_arrow_right",
    "fg_slot_04_arrow_left", "fg_slot_04_arrow_right",
...
const char* const szFindLanSessionBoolean[3] = {
    "MPFRONTEND_ANY", "MPFRONTEND_OFF", "MPFRONTEND_ON",
};
...
Mapinfo_t g_TheMapInfo[64] = {
  { 0, 0, "MPFRONTEND_MERVILLE", "MPLOADING_MERVILLE_TITLE", "mp_merv", "MPLOADING_MERVILLE_LOC" },
  { 0, '\x02', "MPFRONTEND_EDER_DAM", "MPLOADING_EDER_DAM_TITLE", "ederdam", "MPLOADING_EDER_DAM_LOC" },
  { 0, '\x03', "MPFRONTEND_FUELPLANT", "MPLOADING_FUELPLANT_TITLE", "mp_fuel", "MPLOADING_FUELPLANT_LOC" },
  { 0, '\x04', "MPFRONTEND_MAYENNE", "MPLOADING_MAYENNE_TITLE", "mpmaynne", "MPLOADING_MAYENNE_LOC" },
  { 0, '\x05', "MPFRONTEND_ROUEN", "MPLOADING_ROUEN_TITLE", "rouen", "MPLOADING_ROUEN_LOC" },
  { 0, '\x06', "MPFRONTEND_THE_FOREST", "MPLOADING_THE_FOREST_TITLE", "forest", "MPLOADING_THE_FOREST_LOC" },
  { 0, '\a', "MPFRONTEND_HOSTAGE", "MPLOADING_HOSTAGE_TITLE", "mp_hosta", "MPLOADING_HOSTAGE_LOC" },
  { 0, '\b', "MPFRONTEND_VERDUN", "MPLOADING_VERDUN_TITLE", "verdun", "MPLOADING_VERDUN_LOC" },
  { 0, '`', "MPFRONTEND_TEST", "MPLOADING_TEST_TITLE", "gmtypes", "MPLOADING_TEST_LOC" },
  { 0, 'a', "MPFRONTEND_VEHICLES", "MPLOADING_VEHICLES_TITLE", "mpvehtst", "MPLOADING_VEHICLES_LOC" },
  { 0, 'b', "MPFRONTEND_ISLE", "MPLOADING_ISLE_TITLE", "mp_isle", "MPLOADING_ISLE_LOC" },
  { 0, 'c', "MPFRONTEND_SHIPYARD", "MPLOADING_SHIPYARD_TITLE", "shipyard", "MPLOADING_SHIPYARD_LOC" },
  { 0, '\xFF', "", "", "", "" },
  { 0, 0, "", "", "", "" },
  { 0, 0, "", "", "", "" },
  { 0, 0, "", "", "", "" },
...
extern int dword_F641D0[4 * 1580];   // cg.o
extern unsigned char byte_F64194[4 * 6320];   // cg.o
extern int dword_F641D4[4 * 1580];   // cg.o
...
// ea: 0x00793570
void CreateSessionMenu::SetPanelFile(PanelFile* pf)
{
    if (pf == nullptr)
        ASSERT("pf", "c:\\cod\\code\\game\\mp/ui/CreateSessionMenu.cpp", 137);
    panel = pf;
    ...
    for (int i = 0; i < 6; ++i)
    {
        if (m_pBackgroundArt[i] != nullptr)
            ASSERT("0 == m_pBackgroundArt[i]",
                   "c:\\cod\\code\\game\\mp/ui/CreateSessionMenu.cpp", 146);
        m_pBackgroundArt[i] = panel->GetPointer(szCreateSessionMenuBackgroundArt[i]);
        if (m_pBackgroundArt[i] == nullptr)
            ASSERT("m_pBackgroundArt[i]",
                   "c:\\cod\\code\\game\\mp/ui/CreateSessionMenu.cpp", 149);
    }
    for (int i = 0; i < 4; ++i)
    {
        if (m_pText[i] != nullptr)
            ASSERT("0 == m_pText[i]",
                   "c:\\cod\\code\\game\\mp/ui/CreateSessionMenu.cpp", 155);
        m_pText[i] = panel->GetTextPointer(szCreateSessionMenuText[i]);
        if (m_pText[i] == nullptr)
            ASSERT("m_pText[i]",
                   "c:\\cod\\code\\game\\mp/ui/CreateSessionMenu.cpp", 158);
        const char* translatedText = szCreateSessionMenuTextReferences[i];
        if (i == 3)
        {
    ...
    for (int i = 0; i < 8; ++i)
    {
        if (m_pSlotGeometry[i] != nullptr)
            ASSERT("0 == m_pSlotGeometry[i]",
                   "c:\\cod\\code\\game\\mp/ui/CreateSessionMenu.cpp", 179);
        m_pSlotGeometry[i] = panel->GetPointer(szCreateSessionMenuSlotGeometry[i]);
        if (m_pSlotGeometry[i] == nullptr)
            ASSERT("m_pSlotGeometry[i]",
                   "c:\\cod\\code\\game\\mp/ui/CreateSessionMenu.cpp", 182);
    ...
    for (int i = 0; i < 8; ++i)
    {
        if (m_pSlotText[i] != nullptr)
            ASSERT("0 == m_pSlotText[i]",
                   "c:\\cod\\code\\game\\mp/ui/CreateSessionMenu.cpp", 197);
        m_pSlotText[i] = panel->GetTextPointer(szCreateSessionMenuSlotText[i]);
        if (m_pSlotText[i] == nullptr)
            ASSERT("m_pSlotText[i]",
                   "c:\\cod\\code\\game\\mp/ui/CreateSessionMenu.cpp", 200);
        m_pSlotText[i]->SetText(szCreateSessionMenuSlotTextReferences[i]);
    }

    AddEntry(0, panel->GetTextPointer("cg_slot_01_text_option"), false);
    mGameModeCombo = AddComboBox(
        1, 6, panel->GetTextPointer("cg_slot_01_text_spec"),
        panel->GetPointer("cg_slot_01_arrow_left"),
        panel->GetPointer("cg_slot_01_arrow_right"));
    if (mGameModeCombo == nullptr)
        ASSERT("mGameModeCombo",
               "c:\\cod\\code\\game\\mp/ui/CreateSessionMenu.cpp", 209);
    for (int i = 0; i < 6; ++i)
    {
    ...
    AddEntry(2, panel->GetTextPointer("cg_slot_02_text_option"), false);
    mStartingMapCombo = AddComboBox(
        3, 64, panel->GetTextPointer("cg_slot_02_text_spec"),
        panel->GetPointer("cg_slot_02_arrow_left"),
        panel->GetPointer("cg_slot_02_arrow_right"));
    if (mStartingMapCombo == nullptr)
        ASSERT("mStartingMapCombo",
               "c:\\cod\\code\\game\\mp/ui/CreateSessionMenu.cpp", 218);
    ...
    AddEntry(4, panel->GetTextPointer("cg_slot_03_text_option"), false);
    const int maxPlayersCount = MPUIInterface::GetMaxPlayersCount();
    mNumberOfPlayersCombo = AddComboBox(
        5, maxPlayersCount, panel->GetTextPointer("cg_slot_03_text_spec"),
        panel->GetPointer("cg_slot_03_arrow_left"),
        panel->GetPointer("cg_slot_03_arrow_right"));
    if (mNumberOfPlayersCombo == nullptr)
        ASSERT("mNumberOfPlayersCombo",
               "c:\\cod\\code\\game\\mp/ui/CreateSessionMenu.cpp", 228);
    ...
    for (int i = 0; i < maxPlayersCount; ++i)
    {
        if (i >= 30)
            ASSERT("i < 30",
                   "c:\\cod\\code\\game\\mp/ui/CreateSessionMenu.cpp", 232);
    ...
    AddEntry(6, panel->GetTextPointer("cg_slot_04_text_option"), false);
    m_PrivateSlotsCombo = AddComboBox(
        7, 24, panel->GetTextPointer("cg_slot_04_text_spec"),
        panel->GetPointer("cg_slot_04_arrow_left"),
        panel->GetPointer("cg_slot_04_arrow_right"));
    if (m_PrivateSlotsCombo == nullptr)
        ASSERT("m_PrivateSlotsCombo",
               "c:\\cod\\code\\game\\mp/ui/CreateSessionMenu.cpp", 246);
    for (int i = 0; i < 24; ++i)
    {
        char optionText[32];
        sprintf(optionText, "%i", i);
        Broc::string option(optionText);
        m_PrivateSlotsCombo->AddOption(option);
    }

    MPUIInterface::mServerParams.mGameType =
        (unsigned char)mGameModeCombo->mCurrOption;
    short mapOption = mStartingMapCombo->mCurrOption;
    if (mapOption != 0xFF)
        mapOption = (short)(unsigned char)byte_E386C9[114 * mapOption];
    MPUIInterface::mServerParams.mMapID = (unsigned char)mapOption;
    MPUIInterface::mServerParams.mMaxPlayers =
        (unsigned char)mNumberOfPlayersCombo->mCurrOption;
    MPUIInterface::mServerParams.mPrivateSlots =
        (unsigned char)m_PrivateSlotsCombo->mCurrOption;
...
// ea: 0x0078C9C0
void CreateSessionAdvancedMenu::Update(float time_inc)
{
    FEMenu::Update(time_inc);
    MPUIInterface::Step();
    entries[0]->Highlight(highlighted == 1, true);
...
// ea: 0x007A9D90
void WeaponSelectMenu::SetPanelFileSplitScreen(PanelFile* pf)
{
    mSplitScreenMenu = pf;
    for (int i = 0; i < 7; ++i)
    {
        FEText* TextPointer =
            mSplitScreenMenu->GetTextPointer(szMPWeaponSplitScreenEntriesText[i]);
        TextPointer->SetText(szClassReference[i]);
...
// ea: 0x007978C0
void FindSessionMenu::SetPanelFile(PanelFile* pf)
{
    if (pf == nullptr)
        ASSERT("pf", "c:\\cod\\code\\game\\mp/ui/FindSessionMenu.cpp", 136);
    panel = pf;
    ...
    for (int i = 0; i < 6; ++i)
    {
        if (m_pBackgroundArt[i] != nullptr)
            ASSERT("0 == m_pBackgroundArt[i]",
                   "c:\\cod\\code\\game\\mp/ui/FindSessionMenu.cpp", 145);
        m_pBackgroundArt[i] = panel->GetPointer(szFindSessionMenuBackgroundArt[i]);
        if (m_pBackgroundArt[i] == nullptr)
            ASSERT("m_pBackgroundArt[i]",
                   "c:\\cod\\code\\game\\mp/ui/FindSessionMenu.cpp", 148);
    }
    ...
    for (int i = 0; i < 4; ++i)
    {
        if (m_pText[i] != nullptr)
            ASSERT("0 == m_pText[i]",
                   "c:\\cod\\code\\game\\mp/ui/FindSessionMenu.cpp", 154);
        m_pText[i] = panel->GetTextPointer(szFindSessionMenuText[i]);
        if (m_pText[i] == nullptr)
            ASSERT("m_pText[i]",
                   "c:\\cod\\code\\game\\mp/ui/FindSessionMenu.cpp", 157);
        const char* translatedText = szFindSessionMenuTextReferences[i];
        if (i == 3)
        {
            FEMultiLineText* helpbarText =
                (FEMultiLineText*)mem_heap_malloc(0xA8u);
    ...
    for (int i = 0; i < 12; ++i)
    {
        if (m_pSlotGeometry[i] != nullptr)
            ASSERT("0 == m_pSlotGeometry[i]",
                   "c:\\cod\\code\\game\\mp/ui/FindSessionMenu.cpp", 184);
        m_pSlotGeometry[i] = panel->GetPointer(szFindSessionMenuSlotGeometry[i]);
        if (m_pSlotGeometry[i] == nullptr)
            ASSERT("m_pSlotGeometry[i]",
                   "c:\\cod\\code\\game\\mp/ui/FindSessionMenu.cpp", 187);
        m_pSlotGeometry[i]->SetShown(i <= 9);
    }

    const char* backgroundRow[6] = {
        "bkg_row_01", "bkg_row_02", "bkg_row_03",
        "bkg_row_04", "bkg_row_05", "bkg_row_06",
    };
    for (int i = 0; i < 6; ++i)
    {
        if (m_pBackgroundRow[i] != nullptr)
            ASSERT("0 == m_pBackgroundRow[i]",
                   "c:\\cod\\code\\game\\mp/ui/FindSessionMenu.cpp", 212);
        m_pBackgroundRow[i] = panel->GetPointer(backgroundRow[i]);
        if (m_pBackgroundRow[i] == nullptr)
            ASSERT("m_pBackgroundRow[i]",
                   "c:\\cod\\code\\game\\mp/ui/FindSessionMenu.cpp", 215);
        m_pBackgroundRow[i]->SetShown(i <= 4);
    }

    const char* backgroundLine[5] = {
        "bkg_line_01", "bkg_line_02", "bkg_line_03",
        "bkg_line_04", "bkg_line_05",
    };
    for (int i = 0; i < 5; ++i)
    {
        if (m_pBackgroundLine[i] != nullptr)
            ASSERT("0 == m_pBackgroundLine[i]",
                   "c:\\cod\\code\\game\\mp/ui/FindSessionMenu.cpp", 238);
        m_pBackgroundLine[i] = panel->GetPointer(backgroundLine[i]);
        if (m_pBackgroundLine[i] == nullptr)
            ASSERT("m_pBackgroundLine[i]",
                   "c:\\cod\\code\\game\\mp/ui/FindSessionMenu.cpp", 241);
    ...
    for (int i = 0; i < 10; ++i)
    {
        if (m_pSlotText[i] != nullptr)
            ASSERT("0 == m_pSlotText[i]",
                   "c:\\cod\\code\\game\\mp/ui/FindSessionMenu.cpp", 255);
        m_pSlotText[i] = panel->GetTextPointer(szFindSessionMenuSlotText[i]);
        if (m_pSlotText[i] == nullptr)
            ASSERT("m_pSlotText[i]",
                   "c:\\cod\\code\\game\\mp/ui/FindSessionMenu.cpp", 258);
        m_pSlotText[i]->SetText(szFindSessionMenuSlotTextReferences[i]);
    }
    SetDefaultColorScheme(10);

    AddEntry(0, panel->GetTextPointer("fg_slot_01_text_option"), false);
    mGameModeCombo = AddComboBox(
        1, 7, panel->GetTextPointer("fg_slot_01_text_spec"),
        panel->GetPointer("fg_slot_01_arrow_left"),
        panel->GetPointer("fg_slot_01_arrow_right"));
    if (mGameModeCombo == nullptr)
        ASSERT("mGameModeCombo",
               "c:\\cod\\code\\game\\mp/ui/FindSessionMenu.cpp", 273);
    {
        Broc::string option("MPFRONTEND_ANY");
        mGameModeCombo->AddOption(option);
    }
    for (int i = 0; i < 6; ++i)
    {
    ...
    mGameModeCombo->SetCurrOption(0);

    AddEntry(2, panel->GetTextPointer("fg_slot_02_text_option"), false);
    mStartingMapCombo = AddComboBox(
        3, 65, panel->GetTextPointer("fg_slot_02_text_spec"),
        panel->GetPointer("fg_slot_02_arrow_left"),
        panel->GetPointer("fg_slot_02_arrow_right"));
    if (mStartingMapCombo == nullptr)
        ASSERT("mStartingMapCombo",
               "c:\\cod\\code\\game\\mp/ui/FindSessionMenu.cpp", 285);
    {
        Broc::string option("MPFRONTEND_ANY");
        mStartingMapCombo->AddOption(option);
    }
    ...
    {
        const char mapIndex = i == 0xFF ? (char)-1 : byte_E386C9[114 * i];
        Broc::string option(MPUIInterface::GetMapString(
            (unsigned char)mapIndex));
        mStartingMapCombo->AddOption(option);
    }
    mStartingMapCombo->SetCurrOption(0);

    AddEntry(4, panel->GetTextPointer("fg_slot_03_text_option"), false);
    const int maxPlayersCount = MPUIInterface::GetMaxPlayersCount();
    mNumberOfPlayersCombo = AddComboBox(
        5, maxPlayersCount + 1,
        panel->GetTextPointer("fg_slot_03_text_spec"),
        panel->GetPointer("fg_slot_03_arrow_left"),
        panel->GetPointer("fg_slot_03_arrow_right"));
    if (mNumberOfPlayersCombo == nullptr)
        ASSERT("mNumberOfPlayersCombo",
               "c:\\cod\\code\\game\\mp/ui/FindSessionMenu.cpp", 297);
    {
        Broc::string option("MPFRONTEND_ANY");
        mNumberOfPlayersCombo->AddOption(option);
    }
    for (int i = 0; i < MPUIInterface::GetMaxPlayersCount(); ++i)
    {
        char szString[16];
        sprintf(szString, "%d", MPUIInterface::GetMaxPlayers(i));
        Broc::string option(szString);
        mNumberOfPlayersCombo->AddOptionNoLocalize(option);
    }
    mNumberOfPlayersCombo->SetCurrOption(0);

    AddEntry(6, panel->GetTextPointer("fg_slot_04_text_option"), false);
    m_AutoTeamBalanceCombo = AddComboBox(
        7, 3, panel->GetTextPointer("fg_slot_04_text_spec"),
        panel->GetPointer("fg_slot_04_arrow_left"),
        panel->GetPointer("fg_slot_04_arrow_right"));
    if (m_AutoTeamBalanceCombo == nullptr)
        ASSERT("m_AutoTeamBalanceCombo",
               "c:\\cod\\code\\game\\mp/ui/FindSessionMenu.cpp", 312);
    for (int i = 0; i < 3; ++i)
    {
        Broc::string option(szFindSessionBoolean[i]);
        m_AutoTeamBalanceCombo->AddOption(option);
    }
    m_AutoTeamBalanceCombo->SetCurrOption(0);

    AddEntry(8, panel->GetTextPointer("fg_slot_05_text_option"), false);
    m_TeamDamageCombo = AddComboBox(
        9, 3, panel->GetTextPointer("fg_slot_05_text_spec"),
        panel->GetPointer("fg_slot_05_arrow_left"),
        panel->GetPointer("fg_slot_05_arrow_right"));
    if (m_TeamDamageCombo == nullptr)
        ASSERT("m_TeamDamageCombo",
               "c:\\cod\\code\\game\\mp/ui/FindSessionMenu.cpp", 324);
    for (int i = 0; i < 3; ++i)
    {
        Broc::string option(szFindSessionBoolean[i]);
        m_TeamDamageCombo->AddOption(option);
    }
    m_TeamDamageCombo->SetCurrOption(0);
...
// ea: 0x00798DA0
void FindLanSessionMenu::SetPanelFile(PanelFile* pf)
{
    if (pf == nullptr)
        ASSERT("pf", "c:\\cod\\code\\game\\mp/ui/FindLanSessionMenu.cpp", 126);
    panel = pf;
    ...
    for (int i = 0; i < 4; ++i)
    {
        if (m_pBackgroundArt[i] != nullptr)
            ASSERT("0 == m_pBackgroundArt[i]",
                   "c:\\cod\\code\\game\\mp/ui/FindLanSessionMenu.cpp", 135);
        m_pBackgroundArt[i] = panel->GetPointer(szFindLanSessionMenuBackgroundArt[i]);
        if (m_pBackgroundArt[i] == nullptr)
            ASSERT("m_pBackgroundArt[i]",
                   "c:\\cod\\code\\game\\mp/ui/FindLanSessionMenu.cpp", 138);
    }
    ...
    for (int i = 0; i < 4; ++i)
    {
        if (m_pText[i] != nullptr)
            ASSERT("0 == m_pText[i]",
                   "c:\\cod\\code\\game\\mp/ui/FindLanSessionMenu.cpp", 144);
        m_pText[i] = panel->GetTextPointer(szFindLanSessionMenuText[i]);
        if (m_pText[i] == nullptr)
            ASSERT("m_pText[i]",
                   "c:\\cod\\code\\game\\mp/ui/FindLanSessionMenu.cpp", 147);
        const char* translatedText = szFindLanSessionMenuTextReferences[i];
        if (i == 3)
        {
            FEMultiLineText* helpbarText =
                (FEMultiLineText*)mem_heap_malloc(0xA8u);
    ...
    for (int i = 0; i < 12; ++i)
    {
        if (m_pSlotGeometry[i] != nullptr)
            ASSERT("0 == m_pSlotGeometry[i]",
                   "c:\\cod\\code\\game\\mp/ui/FindLanSessionMenu.cpp", 174);
        m_pSlotGeometry[i] = panel->GetPointer(szFindLanSessionMenuSlotGeometry[i]);
        if (m_pSlotGeometry[i] == nullptr)
            ASSERT("m_pSlotGeometry[i]",
                   "c:\\cod\\code\\game\\mp/ui/FindLanSessionMenu.cpp", 177);
        m_pSlotGeometry[i]->SetShown(i <= 9);
    }
    ...
    for (int i = 0; i < 10; ++i)
    {
        if (m_pSlotText[i] != nullptr)
            ASSERT("0 == m_pSlotText[i]",
                   "c:\\cod\\code\\game\\mp/ui/FindLanSessionMenu.cpp", 191);
        m_pSlotText[i] = panel->GetTextPointer(szFindLanSessionMenuSlotText[i]);
        if (m_pSlotText[i] == nullptr)
            ASSERT("m_pSlotText[i]",
                   "c:\\cod\\code\\game\\mp/ui/FindLanSessionMenu.cpp", 194);
        m_pSlotText[i]->SetText(szFindLanSessionMenuSlotTextReferences[i]);
    }
    SetDefaultColorScheme(10);
    ...
    if (mGameModeCombo == nullptr)
        ASSERT("mGameModeCombo",
               "c:\\cod\\code\\game\\mp/ui/FindLanSessionMenu.cpp", 209);
    {
        Broc::string option("MPFRONTEND_ANY");
        mGameModeCombo->AddOption(option);
    }
    ...
    if (mStartingMapCombo == nullptr)
        ASSERT("mStartingMapCombo",
               "c:\\cod\\code\\game\\mp/ui/FindLanSessionMenu.cpp", 222);
    {
        Broc::string option("MPFRONTEND_ANY");
        mStartingMapCombo->AddOption(option);
    }
    ...
    if (mNumberOfPlayersCombo == nullptr)
        ASSERT("mNumberOfPlayersCombo",
               "c:\\cod\\code\\game\\mp/ui/FindLanSessionMenu.cpp", 236);
    {
        Broc::string option("MPFRONTEND_ANY");
        mNumberOfPlayersCombo->AddOption(option);
    }
    ...
    if (m_AutoTeamBalanceCombo == nullptr)
        ASSERT("m_AutoTeamBalanceCombo",
               "c:\\cod\\code\\game\\mp/ui/FindLanSessionMenu.cpp", 252);
    for (int i = 0; i < 3; ++i)
    {
        Broc::string option(szFindLanSessionBoolean[i]);
        m_AutoTeamBalanceCombo->AddOption(option);
    }
    m_AutoTeamBalanceCombo->SetCurrOption(0);
    ...
    if (m_TeamDamageCombo == nullptr)
        ASSERT("m_TeamDamageCombo",
               "c:\\cod\\code\\game\\mp/ui/FindLanSessionMenu.cpp", 264);
    for (int i = 0; i < 3; ++i)
    {
        Broc::string option(szFindLanSessionBoolean[i]);
        m_TeamDamageCombo->AddOption(option);
    ...
    for (int i = 0; i < 6; ++i)
    {
        if (m_pBackgroundRow[i] != nullptr)
            ASSERT("0 == m_pBackgroundRow[i]",
                   "c:\\cod\\code\\game\\mp/ui/FindLanSessionMenu.cpp", 285);
        m_pBackgroundRow[i] = panel->GetPointer(backgroundRow[i]);
        if (m_pBackgroundRow[i] == nullptr)
            ASSERT("m_pBackgroundRow[i]",
                   "c:\\cod\\code\\game\\mp/ui/FindLanSessionMenu.cpp", 288);
        m_pBackgroundRow[i]->SetShown(i <= 4);
    }
    ...
    for (int i = 0; i < 5; ++i)
    {
        if (m_pBackgroundLine[i] != nullptr)
            ASSERT("0 == m_pBackgroundLine[i]",
                   "c:\\cod\\code\\game\\mp/ui/FindLanSessionMenu.cpp", 311);
        m_pBackgroundLine[i] = panel->GetPointer(backgroundLine[i]);
        if (m_pBackgroundLine[i] == nullptr)
            ASSERT("m_pBackgroundLine[i]",
                   "c:\\cod\\code\\game\\mp/ui/FindLanSessionMenu.cpp", 314);
        m_pBackgroundLine[i]->SetShown(true);
    }
...
// ea: 0x007966E0
void CreateLanSessionAdvancedMenu::SetPanelFile(PanelFile* pf)
{
    if (pf == nullptr)
        ASSERT("pf", "c:\\cod\\code\\game\\mp/ui/CreateLanSessionAdvancedMenu.cpp", 322);
    panel = pf;
    ...
    for (int i = 0; i < 4; ++i)
    {
        if (m_pBackgroundArt[i] != nullptr)
            ASSERT("m_pBackgroundArt[i] == 0",
                   "c:\\cod\\code\\game\\mp/ui/CreateLanSessionAdvancedMenu.cpp", 328);
        m_pBackgroundArt[i] = panel->GetPointer(szCreateLanSessionAdvMenuBgArt[i]);
        if (m_pBackgroundArt[i] == nullptr)
            ASSERT("m_pBackgroundArt[i]",
                   "c:\\cod\\code\\game\\mp/ui/CreateLanSessionAdvancedMenu.cpp", 331);
    }
    ...
    for (int i = 0; i < 4; ++i)
    {
        if (m_pText[i] != nullptr)
            ASSERT("m_pText[i] == 0",
                   "c:\\cod\\code\\game\\mp/ui/CreateLanSessionAdvancedMenu.cpp", 337);
        m_pText[i] = panel->GetTextPointer(szCreateLanSessionAdvMenuText[i]);
        if (m_pText[i] == nullptr)
            ASSERT("m_pText[i]",
                   "c:\\cod\\code\\game\\mp/ui/CreateLanSessionAdvancedMenu.cpp", 340);
        const char* translatedText = szCreateLanSessionAdvMenuTextRef[i];
        if (i == 3)
        {
            FEMultiLineText* helpbarText =
                (FEMultiLineText*)mem_heap_malloc(0xA8u);
    ...
    for (int i = 0; i < 6; ++i)
    {
        if (m_pBackgroundRow[i] != nullptr)
            ASSERT("m_pBackgroundRow[i] == 0",
                   "c:\\cod\\code\\game\\mp/ui/CreateLanSessionAdvancedMenu.cpp", 361);
        m_pBackgroundRow[i] = panel->GetPointer(szCreateLanSessionAdvMenuBgRow[i]);
        if (m_pBackgroundRow[i] == nullptr)
            ASSERT("m_pBackgroundRow[i]",
                   "c:\\cod\\code\\game\\mp/ui/CreateLanSessionAdvancedMenu.cpp", 364);
        m_pBackgroundRow[i]->SetShown(true);
    }
    ...
    for (int i = 0; i < 5; ++i)
    {
        if (m_pBackgroundLine[i] != nullptr)
            ASSERT("m_pBackgroundLine[i] == 0",
                   "c:\\cod\\code\\game\\mp/ui/CreateLanSessionAdvancedMenu.cpp", 372);
        m_pBackgroundLine[i] = panel->GetPointer(szCreateLanSessionAdvMenuBgLine[i]);
        if (m_pBackgroundLine[i] == nullptr)
            ASSERT("m_pBackgroundLine[i]",
                   "c:\\cod\\code\\game\\mp/ui/CreateLanSessionAdvancedMenu.cpp", 375);
        m_pBackgroundLine[i]->SetShown(true);
    }
    SetDefaultColorScheme(10);
    ...
    for (int i = 0; i < 12; ++i)
    {
        if (m_pSlotArrow[i] != nullptr)
            ASSERT("m_pSlotArrow[i] == 0",
                   "c:\\cod\\code\\game\\mp/ui/CreateLanSessionAdvancedMenu.cpp", 385);
        m_pSlotArrow[i] = panel->GetPointer(szCreateLanSessionAdvMenuSlotArrows[i]);
        if (m_pSlotArrow[i] == nullptr)
            ASSERT("m_pSlotArrow[i]",
                   "c:\\cod\\code\\game\\mp/ui/CreateLanSessionAdvancedMenu.cpp", 388);
        m_pSlotArrow[i]->SetShown(true);
    }
    ...
    for (int i = 0; i < 12; ++i)
    {
        if (m_pSlotText[i] != nullptr)
            ASSERT("m_pSlotText[i] == 0",
                   "c:\\cod\\code\\game\\mp/ui/CreateLanSessionAdvancedMenu.cpp", 396);
        m_pSlotText[i] = panel->GetTextPointer(szCreateLanSessionAdvMenuSlotText[i]);
        if (m_pSlotText[i] == nullptr)
            ASSERT("m_pSlotText[i]",
                   "c:\\cod\\code\\game\\mp/ui/CreateLanSessionAdvancedMenu.cpp", 399);
        m_pSlotText[i]->SetText(szCreateLanSessionAdvMenuSlotTextRef[i]);
    }
    SetDefaultColorScheme(10);
    ...
    if (m_TimeLimitCombo == nullptr)
        ASSERT("m_TimeLimitCombo",
               "c:\\cod\\code\\game\\mp/ui/CreateLanSessionAdvancedMenu.cpp", 411);
    for (int jj = 0; jj < MPUIInterface::GetTimeLimitCount(); ++jj)
    {
        char szNum[32];
        sprintf(szNum, "%i", MPUIInterface::GetTimeLimit(jj));
    ...
    if (m_ScoreLimitCombo == nullptr)
        ASSERT("m_ScoreLimitCombo",
               "c:\\cod\\code\\game\\mp/ui/CreateLanSessionAdvancedMenu.cpp", 423);
    for (int kk = 0;
         kk < MPUIInterface::GetScoreLimitCount(GAME_TYPE_WAR); ++kk)
    {
        char string[32];
    ...
    if (m_AutoTeamBalanceCombo == nullptr)
        ASSERT("m_AutoTeamBalanceCombo",
               "c:\\cod\\code\\game\\mp/ui/CreateLanSessionAdvancedMenu.cpp", 438);
    for (int i = 0; i < 2; ++i)
    {
        Broc::string option(szLanOnOff[i]);
        m_AutoTeamBalanceCombo->AddOption(option);
    }
    ...
    if (m_TeamDamageCombo == nullptr)
        ASSERT("m_TeamDamageCombo",
               "c:\\cod\\code\\game\\mp/ui/CreateLanSessionAdvancedMenu.cpp", 447);
    for (int i = 0; i < 2; ++i)
    {
        Broc::string option(szLanOnOff[i]);
        m_TeamDamageCombo->AddOption(option);
    ...
    if (m_VotingCombo == nullptr)
        ASSERT("m_VotingCombo",
               "c:\\cod\\code\\game\\mp/ui/CreateLanSessionAdvancedMenu.cpp", 456);
    for (int i = 0; i < 2; ++i)
    {
        Broc::string option(szOnOffOptions[i]);
        m_VotingCombo->AddOption(option);
    ...
    if (m_PenaltyVoteCombo == nullptr)
        ASSERT("m_PenaltyVoteCombo",
               "c:\\cod\\code\\game\\mp/ui/CreateLanSessionAdvancedMenu.cpp", 465);
    for (int i = 0; i < 2; ++i)
    {
        Broc::string option(szOnOffOptions[i]);
        m_PenaltyVoteCombo->AddOption(option);
