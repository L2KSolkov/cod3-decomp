...
extern struct cvar_t* cl_grenadeButtonDown;
extern struct cvar_t* cl_binocButtonDown;
extern struct cvar_t* cl_altFireButtonDown;
extern struct cvar_t* cl_analogStickLean;
extern struct cvar_t* cl_freeze;
extern struct cvar_t* cl_conXOffset;
extern struct cvar_t* cl_viewPitchCompensate;
extern struct cvar_t* cl_viewYawCompensate;
extern struct cvar_t* m_pitch;
extern struct cvar_t* m_yaw;
extern struct cvar_t* m_forward;
extern struct cvar_t* m_side;
extern struct cvar_t* m_filter;
extern struct cvar_t* cg_viewsize;
extern struct cvar_t* fx_enable;
extern struct cvar_t* fx_draw;
extern struct cvar_t* fx_cull;
extern struct cvar_t* fx_cullscale;
extern struct cvar_t* fx_cullbias;
extern struct cvar_t* fx_freeze;
extern struct cvar_t* fx_debug;
...
void CL_Init()
{
    ...
    cl_grenadeButtonDown = Cvar_Get("cl_grenadeButtonDown", "0", 256);
    cl_binocButtonDown = Cvar_Get("cl_binocButtonDown", "0", 256);
    cl_altFireButtonDown = Cvar_Get("cl_altFireButtonDown", "0", 256);
    cl_analogStickLean = Cvar_Get("cl_analogStickLean", "0", 256);
    cl_showMouseRate = Cvar_Get("cl_showmouserate", "0", 0);
    cl_freeze = Cvar_Get("cl_freeze", "0", 0);
    cl_conXOffset = Cvar_Get("cl_conXOffset", "0", 0);
    cl_viewPitchCompensate = Cvar_Get("cl_viewPitchCompensate", "0", 64);
    cl_viewYawCompensate = Cvar_Get("cl_viewYawCompensate", "0", 64);
    m_pitch = Cvar_Get("m_pitch", "0.7", 1);
    m_yaw = Cvar_Get("m_yaw", "0.7", 1);
    m_forward = Cvar_Get("m_forward", "0.25", 1);
    m_side = Cvar_Get("m_side", "0.25", 1);
    m_filter = Cvar_Get("m_filter", "0", 1);
    cg_viewsize = Cvar_Get("cg_viewsize", "100", 1);
    fx_enable = Cvar_Get("fx_enable", "1", 512);
    fx_draw = Cvar_Get("fx_draw", "1", 512);
    fx_cull = Cvar_Get("fx_cull", "1", 0);
    fx_cullscale = Cvar_Get("fx_cullscale", "1", 1);
    fx_cullbias = Cvar_Get("fx_cullbias", "0", 1);
    fx_freeze = Cvar_Get("fx_freeze", "0", 512);
    fx_debug = Cvar_Get("fx_debug", "0", 512);
    fx_count = Cvar_Get("fx_count", "0", 512);
