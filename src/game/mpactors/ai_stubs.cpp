...
// ea: 0x0077C750  (?Path_CompleteLookahead@@YI?BHPBUpath_t@@@Z)
    const int __fastcall Path_CompleteLookahead(const path_t*)
{
    return 0;
}
...
// ea: 0x0077C780  (?Path_AllowsObstacleNegotiation@@YI?BHPBUpath_t@@@Z)
    const int __fastcall Path_AllowsObstacleNegotiation(const path_t*)
{
    return 0;
}
...
// ea: 0x0077CAE0  (?Path_FindPathFromTo@@YI?BHPAUpath_t@@W4team_t@@PAUPathNode@PathNodes@@QBM23H@Z)
    const int __fastcall Path_FindPathFromTo(path_t*, team_t, PathNodes::PathNode*, const float* const, PathNodes::PathNode*, const float* const, int)
{
    return 0;
}

// ea: 0x0077CAF0  (?Path_FindPathNotCrossPlanes@@YI?BHPAUpath_t@@W4team_t@@QBM2QAY01MQAMHH@Z)
    const int __fastcall Path_FindPathNotCrossPlanes(path_t*, team_t, const float* const, const float* const, float (*)[2], float* const, int, int)
{
    return 0;
}
...
// ea: 0x0077CB10  (?Path_FindPathFromToNotCrossPlanes@@YI?BHPAUpath_t@@W4team_t@@PAUPathNode@PathNodes@@QBM23QAY01MQAMHH@Z)
    const int __fastcall Path_FindPathFromToNotCrossPlanes(path_t*, team_t, PathNodes::PathNode*, const float* const, PathNodes::PathNode*, const float* const, float (*)[2], float* const, int, int)
{
    return 0;
}
...
// ea: 0x0077CB50  (?Path_FindPathFromAwayNotCrossPlanes@@YI?BHPAUpath_t@@W4team_t@@PAUPathNode@PathNodes@@QBM3MQAY01MQAMHH@Z)
    const int __fastcall Path_FindPathFromAwayNotCrossPlanes(path_t*, team_t, PathNodes::PathNode*, const float* const, const float* const, float, float (*)[2], float* const, int, int)
{
    return 0;
}
...
// ea: 0x0077CB70  (?Path_FindPathNearNotCrossPlanes@@YI?BHPAUpath_t@@W4team_t@@QBM2MQAY01MQAMHH@Z)
    const int __fastcall Path_FindPathNearNotCrossPlanes(path_t*, team_t, const float* const, const float* const, float, float (*)[2], float* const, int, int)
{
    return 0;
}
