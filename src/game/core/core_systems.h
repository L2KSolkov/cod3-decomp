...
enum EEffectContext : int {
    kEffectContextFootstep = 0,
    kEffectContextGearRattle = 1,
    kEffectContextLanding = 2,
    kEffectContextScriptCall = 3,
    kEffectContextWeapon = 4,
    kEffectContextBulletHit = 5,
    kEffectContextGrenadeBounce = 6,
    kEffectContextProjExplode = 7,
    kEffectContextVehicle = 8,
    kEffectContextLight = 9,
    kEffectContextEIMelee = 10,
    EEffectContextCount = 11,
    EEffectContextMin = 0,
    EEffectContextMax = 10,
    EEffectContextInvalid = -1,
};
// Enum tags match binary manglings (W4E*); values reconstructed.
enum ECollisionMaterial : int {
    kCollisionMaterialNONE = 0,
    kCollisionMaterialBARK = 1,
    kCollisionMaterialBRICK = 2,
    kCollisionMaterialCARPET = 3,
    kCollisionMaterialCLOTH = 4,
    kCollisionMaterialCONCRETE = 5,
    kCollisionMaterialDIRT = 6,
    kCollisionMaterialFLESH = 7,
    kCollisionMaterialFOLIAGE = 8,
    kCollisionMaterialGLASS = 9,
    kCollisionMaterialGRASS = 10,
    kCollisionMaterialGRAVEL = 11,
    kCollisionMaterialICE = 12,
    kCollisionMaterialMETAL = 13,
    kCollisionMaterialMUD = 14,
    kCollisionMaterialPAPER = 15,
    kCollisionMaterialPLASTER = 16,
    kCollisionMaterialROCK = 17,
    kCollisionMaterialSAND = 18,
    kCollisionMaterialSNOW = 19,
    kCollisionMaterialWATER = 20,
    kCollisionMaterialWOOD = 21,
    kCollisionMaterialASPHALT = 22,
    kCollisionMaterialCount = 23,
    kCollisionMaterialMin = 0,
    kCollisionMaterialMax = 22,
    kCollisionMaterialInvalid = -1,
};
enum EStanceType : int {
    kStanceSprint = 0,
    kStanceRun = 1,
    kStanceWalk = 2,
    kStanceProne = 3,
...
enum EWeaponClass : int {
    kWeaponClassSMG = 0,
    kWeaponClassPISTOL = 1,
    kWeaponClassRIFLE = 2,
    kWeaponClassLMG = 3,
    kWeaponClassHMG = 4,
    kWeaponClassUMG = 5,
    ...
    kWeaponClassMin = 0,
    kWeaponClassMax = 5,
    kWeaponClassInvalid = -1,
};
enum EAction : int {
    kActionNONE = 0,
    kActionWEAPON_VIEW_FLASH = 1,
    kActionWEAPON_WORLD_FLASH = 2,
    kActionWEAPON_SHELL_EJECT = 3,
    kActionWEAPON_LAST_SHOT_EJECT = 4,
    kActionWEAPON_PICKUP = 5,
    kActionWEAPON_AMMO_PICKUP = 6,
    kActionWEAPON_FIRE_1ST = 7,
    kActionWEAPON_FIRE_3RD = 8,
    kActionWEAPON_LAST_SHOT_1ST = 9,
    kActionWEAPON_LAST_SHOT_3RD = 10,
    kActionWEAPON_LOOP_FIRE = 11,
    kActionWEAPON_STOP_FIRE = 12,
    kActionWEAPON_RECHAMBER = 13,
    kActionWEAPON_RELOAD = 14,
    kActionWEAPON_RELOAD_EMPTY = 15,
    kActionWEAPON_RELOAD_START = 16,
    kActionWEAPON_RELOAD_END = 17,
    kActionWEAPON_ALT_SWITCH = 18,
    kActionWEAPON_RAISE = 19,
    kActionWEAPON_PUT_AWAY = 20,
    kActionWEAPON_DEPLOY = 21,
    kActionWEAPON_BREAKDOWN = 22,
    kActionWEAPON_NOTE_TRACK_SOUND_A = 23,
    kActionWEAPON_NOTE_TRACK_SOUND_B = 24,
    kActionWEAPON_NOTE_TRACK_SOUND_C = 25,
    kActionWEAPON_NOTE_TRACK_SOUND_D = 26,
    kActionVEHICLE_IDLE = 27,
    kActionVEHICLE_IDLE_MAIN_PLAYER_ONBOARD = 28,
    kActionVEHICLE_LOOP = 29,
    kActionVEHICLE_LOOP_MAIN_PLAYER_ONBOARD = 30,
    kActionVEHICLE_START = 31,
    kActionVEHICLE_RUMBLE = 32,
    kActionVEHICLE_WHEELDUST = 33,
    kActionVEHICLE_TURRET_ROT = 34,
    kActionVEHICLE_TURRET_STOP = 35,
    kActionVEHICLE_EXPLODE_START = 36,
    kActionVEHICLE_EXPLODE_LOOP = 37,
    kActionVEHICLE_EXPLODE_END = 38,
    kActionVEHICLE_CRASH = 39,
    kActionVEHICLE_BRAKE = 40,
    kActionVEHICLE_HORN = 41,
    kActionWEAPON_SHAKEANDRUMBLE = 42,
    kActionWEAPON_OVERHEATING = 43,
    kActionWEAPON_OVERHEATED = 44,
    kActionBAZOOKA_TRAIL = 45,
    kActionEI_MELEE_STRUGGLE = 46,
    kActionEI_MELEE_PLAYER_WINNING = 47,
    kActionEI_MELEE_PLAYER_LOSING = 48,
    kActionCount = 49,
    kActionMin = 0,
    kActionMax = 48,
    kActionInvalid = -1,
...
public:
    ...
    ActiveEffectSet* DereferenceHandle(Handle handle) const;    // ea: 0x004E5D50
