...
cvar_t* cl_grenadeButtonDown;    // ?cl_grenadeButtonDown@@3PAUcvar_t@@A (cl.o @ 0xF133A4)
cvar_t* cl_binocButtonDown;      // ?cl_binocButtonDown@@3PAUcvar_t@@A (cl.o @ 0xF11E40)
cvar_t* cl_altFireButtonDown;    // ?cl_altFireButtonDown@@3PAUcvar_t@@A (cl.o @ 0xF15778)
cvar_t* cl_analogStickLean;      // ?cl_analogStickLean@@3PAUcvar_t@@A (cl.o @ 0xF0D004)
cvar_t* cl_conXOffset;           // ?cl_conXOffset@@3PAUcvar_t@@A (cl.o @ 0xF0CC28)
...
cvar_t* m_forward;               // ?m_forward@@3PAUcvar_t@@A (cl.o)
cvar_t* m_side;                  // ?m_side@@3PAUcvar_t@@A (cl.o)
cvar_t* m_filter;                // ?m_filter@@3PAUcvar_t@@A (cl.o)
cvar_t* cg_viewsize;             // ?cg_viewsize@@3PAUcvar_t@@A (cl.o)
cvar_t* fx_enable;               // ?fx_enable@@3PAUcvar_t@@A (cl.o)
cvar_t* fx_draw;                 // ?fx_draw@@3PAUcvar_t@@A (cl.o)
cvar_t* fx_cull;                 // ?fx_cull@@3PAUcvar_t@@A (cl.o)
cvar_t* fx_cullscale;            // ?fx_cullscale@@3PAUcvar_t@@A (cl.o)
cvar_t* fx_cullbias;             // ?fx_cullbias@@3PAUcvar_t@@A (cl.o)
cvar_t* fx_freeze;               // ?fx_freeze@@3PAUcvar_t@@A (cl.o)
cvar_t* fx_debug;                // ?fx_debug@@3PAUcvar_t@@A (cl.o)
cvar_t* fx_count;                // ?fx_count@@3PAUcvar_t@@A (cl.o)
