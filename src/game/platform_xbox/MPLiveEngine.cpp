...
{
    (void)vehicle; (void)player; (void)seatIdx; (void)entryIdx;
}
...
void MultiplayerMgr::BulletHit(const math::Position3& position,
                               ...
                               Entity* hitEntity)
{
    (void)position; (void)normal; (void)surfaceType; (void)weapon;
    (void)hitEntity;
}
