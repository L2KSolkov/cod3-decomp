// apsColorUVARendererShaderData.cpp — exact release shader microcode and storage.
// Source: aeps_xboxr:apsColorUVARendererVertex.o (IDA data at 0xE4ABB0/0xE4AC98).
