// apsRectangleRendererShaderData.cpp — exact release shader microcode and storage.
// Source: aeps_xboxr:apsRectangleRendererVertex.o (IDA data at 0xE4A980/0xE4AA68).
...
unsigned long* VS = (unsigned long*)&VShaderHandle;
const unsigned long** VShaderTable = (const unsigned long**)VShaderTableStorage;
}
...
const unsigned long** PShaderTable = (const unsigned long**)PShaderTableStorage;
}
