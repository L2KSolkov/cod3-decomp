...
struct apsColorUVARender {
    ...
    static void RegisterVShader() { nglDxRegisterVShader((unsigned int*)VS, VShaderTable[0]); }   // ea: 0x805420
};
struct apsColorUVARenderPixel {
    ...
    static void RegisterPShader() { nglDxRegisterPShader((unsigned int**)PS, PShaderTable[0]); }   // ea: 0x805400
