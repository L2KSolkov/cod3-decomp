...
public:
    virtual void GetDesc(char* buf);  // ea: 0x8053F0
};
...
struct apsColorUVARender {
    ...
    static void RegisterVShader() { nglDxRegisterVShader(VS, VShaderTable[0]); }   // ea: 0x805420
};
...
struct apsColorUVARenderPixel {
    ...
    static void RegisterPShader() { nglDxRegisterPShader(PS, PShaderTable[0]); }   // ea: 0x805400
