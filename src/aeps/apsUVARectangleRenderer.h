...
struct apsUVARectangleRender {
    ...
    static void RegisterVShader() { nglDxRegisterVShader((unsigned int*)VS, VShaderTable[0]); }   // ea: 0x804F70
};
struct apsUVARectangleRenderPixel {
    ...
    static void RegisterPShader() { nglDxRegisterPShader((unsigned int**)PS, PShaderTable[0]); }   // ea: 0x804F50
