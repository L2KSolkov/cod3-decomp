// apsColorBillboardRendererShaderData.cpp — exact release shader microcode and storage.
// Source: aeps_xboxr:apsColorBillboardRendererVertex.o (IDA data at 0xE4ADE0/0xE4AEC8).
